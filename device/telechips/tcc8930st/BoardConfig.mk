...
TARGET_BOOTLOADER_BOARD_NAME := tcc8930st_evm
...
KERNEL_DEFCONFIG := tcc8930st_defconfig
...
ifeq ($(PRODUCT_MODEL),TCC8930_STB_EV)
    REALTEK_MODULE_NAME := rt8188cu
endif
ifeq ($(PRODUCT_MODEL),TCC8930_YJ8930T)
    REALTEK_MODULE_NAME := rt8188eus
endif
ifeq ($(PRODUCT_MODEL),TCC8933_YJ8933T)
    REALTEK_MODULE_NAME := rt8188eus
endif
ifeq ($(PRODUCT_MODEL),TCC8935_YJ8935T)
    REALTEK_MODULE_NAME := rt8189es
endif
ifeq ($(PRODUCT_MODEL),TCC8935_UPC)
    REALTEK_MODULE_NAME := rt8188eus
    BOARD_USES_WPS := true
endif
ifeq ($(PRODUCT_MODEL),TCC8935_HDMI_DONGLE)
    REALTEK_MODULE_NAME := rt8189es
    BOARD_USES_WPS := true
endif
...
TARGET_RECOVERY_UI_LIB := librecovery_ui_tcc8930st
