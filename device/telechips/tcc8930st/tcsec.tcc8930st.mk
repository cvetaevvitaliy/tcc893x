...
PRODUCT_PACKAGES += \
	libhciphapi
PRODUCT_COPY_FILES += \
	device/telechips/tcc893x/init.tcc893x.hidden.rc:root/init.tcc8930st.hidden.rc \
	device/telechips/tcc893x/init.tcc893x.hidden.nand.rc:root/init.tcc8930st.hidden.nand.rc \
	device/telechips/tcc893x/init.tcc893x.hidden.emmc.rc:root/init.tcc8930st.hidden.emmc.rc \
...
PRODUCT_COPY_FILES += \
	device/telechips/tcc893x/init.tcc893x.wodrm.rc:root/init.tcc8930st.hidden.rc
endif
...
PRODUCT_PACKAGES += \
	libhdcp2
PRODUCT_COPY_FILES += \
	device/telechips/tcc893x/init.tcc893x.tztee.hdcp2.rc:root/init.tcc8930st.tztee.hdcp2.rc
endif
...
PRODUCT_COPY_FILES += \
	device/telechips/tcc893x/init.tcc893x.tztee.rc:root/init.tcc8930st.tztee.rc \
	device/telechips/tcc893x/init.tcc893x.tztee.tzos.rc:root/init.tcc8930st.tztee.tzos.rc \
...
PRODUCT_COPY_FILES += \
	device/telechips/tcc893x/init.tcc893x.wodrm.rc:root/init.tcc8930st.tztee.rc

ifeq ($(TARGET_USE_TCQRTM), true)
PRODUCT_PACKAGES += \
	libtcqrtmapi
PRODUCT_COPY_FILES += \
	device/telechips/tcc893x/init.tcc893x.tcqrtm.rc:root/init.tcc8930st.tztee.rc \
