...
PRODUCT_COPY_FILES += \
	device/telechips/tcc892x-common/bluetooth/bcm4330.hcd:system/vendor/firmware/bcm4330.hcd

PRODUCT_COPY_FILES += \
       device/telechips/tcc892x-common/bluetooth/BCM4334B0.hcd:system/vendor/firmware/bcm4334.hcd

PRODUCT_COPY_FILES += \
       device/telechips/tcc892x-common/bluetooth/BCM4335B0.hcd:system/vendor/firmware/bcm4335.hcd
...
#
PRODUCT_COPY_FILES += \
	device/telechips/tcc892x-common/ufsd_$(TARGET_BOARD_SOC).ko:root/lib/modules/ufsd.ko
...
PRODUCT_COPY_FILES += \
	device/telechips/tcc892x-common/media_codecs_$(TARGET_BOARD_SOC).xml:system/etc/media_codecs.xml \
...
BOARD_SEPOLICY_DIRS := \
		     device/telechips/tcc892x-common/sepolicy
