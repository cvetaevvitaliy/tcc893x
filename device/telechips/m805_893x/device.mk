...
DEVICE_PACKAGE_OVERLAYS := device/telechips/m805_893x/overlay
...
PRODUCT_COPY_FILES := \
	$(LOCAL_KERNEL):kernel \
	device/telechips/m805_893x/init.m805_893x.rc:root/init.m805_893x.rc \
	device/telechips/m805_893x/init.m805_893x.setupfs.rc:root/init.m805_893x.setupfs.rc \
	device/telechips/m805_893x/init.recovery.m805_893x.rc:root/init.recovery.m805_893x.rc \
	device/telechips/m805_893x/init.m805_893x.nand.rc:root/init.m805_893x.nand.rc \
	device/telechips/m805_893x/init.m805_893x.nand.rc:root/init.recovery.m805_893x.nand.rc \
	device/telechips/m805_893x/init.m805_893x.emmc.rc:root/init.m805_893x.emmc.rc \
	device/telechips/m805_893x/init.m805_893x.emmc.rc:root/init.recovery.m805_893x.emmc.rc \
	device/telechips/m805_893x/fstab.m805_893x:root/fstab.m805_893x \
	device/telechips/m805_893x/ueventd.m805_893x.rc:root/ueventd.m805_893x.rc \
	device/telechips/m805_893x/init.m805_893x.usb.rc:root/init.m805_893x.usb.rc \
	device/telechips/m805_893x/init.m805_893x.wifi.realtek.rc:root/init.m805_893x.wifi.realtek.rc \
	device/telechips/m805_893x/init.m805_893x.wifi.broadcom.rc:root/init.m805_893x.wifi.broadcom.rc

PRODUCT_COPY_FILES += \
	device/telechips/m805_893x/recovery.fstab:root/factory.fstab
...
PRODUCT_COPY_FILES += \
	device/telechips/m805_893x/tcc-ts.idc:system/usr/idc/tcc-ts.idc

PRODUCT_COPY_FILES += \
	device/telechips/m805_893x/tcc-ts-sitronix.idc:system/usr/idc/tcc-ts-sitronix.idc

PRODUCT_COPY_FILES += \
	device/telechips/m805_893x/tcc-ts-goodix-cap.idc:system/usr/idc/tcc-ts-goodix-cap.idc
...
ifeq ($(USE_MASS_STORAGE),true)
PRODUCT_COPY_FILES += \
	device/telechips/m805_893x/ums/vold.fstab:system/etc/vold.fstab\
	device/telechips/m805_893x/ums/vold.emmc.fstab:system/etc/vold.emmc.fstab
else ifeq ($(USE_MASS_STORAGE),false)
#PRODUCT_COPY_FILES += \
	device/telechips/m805_893x/vold.fstab:system/etc/vold.fstab\
	device/telechips/m805_893x/vold.emmc.fstab:system/etc/vold.emmc.fstab
...
$(call inherit-product, device/telechips/m805_893x/tcsec.m805_893x.mk)
