...
void tcc270_init(int i2c_ch)
{
	signed long data[2];
	unsigned char value;
	tcc270_i2c_ch = i2c_ch;
...
int tcc270_output_control(tcc270_src_id id, unsigned int onoff)
{
...
int tcc270_set_voltage(tcc270_src_id id, unsigned int mV)
{
...
int tcc270_set_power(tcc270_src_id id, unsigned int onoff)
{
	if (tcc270_initialized == 0)
		return -1;
