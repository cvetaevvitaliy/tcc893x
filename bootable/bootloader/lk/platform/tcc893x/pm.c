...
static TCC_REG RegRepo;
    ...
    #if defined(TARGET_TCC8930_YJ8930T)
        #define CONFIG_STB_BOARD_YJ8930T
    #elif defined(TARGET_TCC8933_YJ8933T)
        #define CONFIG_STB_BOARD_YJ8933T
    #elif defined(TARGET_TCC8935_YJ8935T)
        #define CONFIG_STB_BOARD_YJ8935T
    #elif defined(TARGET_TCC8935_UPC)
        #define CONFIG_STB_BOARD_UPC_TCC893X
