/****************************************************************************
 *   FileName    : lcd_CLAA070WP03.c
 *   Description : support for CLAA070WP03 LVDS Panel
 ****************************************************************************
 *
 *   TCC Version 1.0
...
static int claa070wp03_set_power(struct lcd_panel *panel, int on)
{
...
static struct lcd_panel claa070wp03_panel = {
	.name		= "CLAA070WP03",
	.manufacturer	= "CPT",
