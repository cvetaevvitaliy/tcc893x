...
static volatile unsigned int    stHDMIReg;
static volatile unsigned int    stHDMIAudReg;
...
void tca_ckc_init(void)
{
    ...
    *(volatile unsigned *)0x73810010 |= 0x80000000;
    ...
    // set to initial vaule of PMU
    tca_ckc_setfbuspwdn(FBUS_DDI, 0);
    tca_ckc_setfbuspwdn(FBUS_GPU, 0);
    tca_ckc_setfbuspwdn(FBUS_VBUS, 0);
    tca_ckc_setfbuspwdn(FBUS_VCORE, 0);
    tca_ckc_setfbuspwdn(FBUS_HSIO, 0);
