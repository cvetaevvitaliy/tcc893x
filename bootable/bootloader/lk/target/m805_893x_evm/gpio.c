...
struct gpio_cfg TCC893X_GPA_init_tbl[] = {
...
struct gpio_cfg TCC893X_GPB_init_tbl[] = {
	...
	{ TCC_GPB(30) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
	{ TCC_GPB(31) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
};

struct gpio_cfg TCC893X_GPC_init_tbl[] = {
...
#else
	{ TCC_GPC(14) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, //OTP_PLLEN
#endif
	...
	{ TCC_GPC(17) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
	{ TCC_GPC(18) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
	{ TCC_GPC(19) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, //OTP_PLLEN
	{ TCC_GPC(20) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
	{ TCC_GPC(21) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
	{ TCC_GPC(22) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
	{ TCC_GPC(23) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
...
struct gpio_cfg TCC893X_GPD_init_tbl[] = {
	...
	{ TCC_GPD(6)  ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, //PWRMEM_CTL not used..
...
struct gpio_cfg TCC893X_GPE_init_tbl[] = {
...
#if defined(CONFIG_CHIP_TCC8935S) || defined(CONFIG_CHIP_TCC8933S) || defined(CONFIG_CHIP_TCC8937S)
	{ TCC_GPE(12) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // HP_DET
	{ TCC_GPE(13) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // MUTE_CTL
	{ TCC_GPE(14) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // TP
#if ((HW_REV == 0x5001) || (HW_REV == 0x5002) || (HW_REV == 0x5003))
	{ TCC_GPE(15) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, // LCD_IODEN
#else
	{ TCC_GPE(15) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // LCD_IODEN
#endif
	{ TCC_GPE(16) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // TP
	{ TCC_GPE(17) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // 4IN1_BGFINT#
	{ TCC_GPE(18) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // TP
	{ TCC_GPE(19) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
	{ TCC_GPE(20) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // 4IN1_PWREN
#else
	{ TCC_GPE(12) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // HP_DET
	{ TCC_GPE(13) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // MUTE_CTL
	{ TCC_GPE(14) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // TP
	{ TCC_GPE(15) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // DXBS_PWDN#
	{ TCC_GPE(16) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // TP
	{ TCC_GPE(17) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // 4IN1_BGFINT#
	{ TCC_GPE(18) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // TP
#if ((HW_REV == 0x5001) || (HW_REV == 0x5002))
	{ TCC_GPE(19) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, // LCD_IODEN
#else
	{ TCC_GPE(19) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // LCD_IODEN
#endif
	{ TCC_GPE(20) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // 4IN1_PWREN
#endif
	{ TCC_GPE(21) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // KEY_CTL2
	{ TCC_GPE(22) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // KEY_CTL3
#if ((HW_REV == 0x5001) || (HW_REV == 0x5002))
	{ TCC_GPE(23) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, // PWRPLL_CTL
#else
	{ TCC_GPE(23) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // TP
#endif//
	{ TCC_GPE(24) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // LCD_PWREN
	{ TCC_GPE(25) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // BM_S0
#if (HW_REV == 0x5003)
	{ TCC_GPE(26) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#else
	{ TCC_GPE(26) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, // TP <- Bruce, someone is touching this port.. to output high..
#endif
	{ TCC_GPE(27) ,GPIO_FN0 , GPIO_INPUT           , GPIO_PULLDISABLE }, // PMU_IRQ
	{ TCC_GPE(28) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, // TFEXT_CD
...
struct gpio_cfg TCC893X_GPF_init_tbl[] = {
...
struct gpio_cfg TCC893X_GPG_init_tbl[] = {
	...
	{ TCC_GPG(18) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLUP      }, // BT RX PORT
	{ TCC_GPG(19) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }
};

struct gpio_cfg TCC893X_GPHDMI_init_tbl[] = {
...
struct gpio_cfg TCC893X_GPADC_init_tbl[] = {
...
void gpio_init_early(void)
{
	...
	for(i=0 ; i<(sizeof(TCC893X_GPA_init_tbl)/sizeof(TCC893X_GPA_init_tbl[0])) ; i++)
		gpio_config(TCC893X_GPA_init_tbl[i].port, TCC893X_GPA_init_tbl[i].function|TCC893X_GPA_init_tbl[i].direction|TCC893X_GPA_init_tbl[i].pull);

	for(i=0 ; i<(sizeof(TCC893X_GPB_init_tbl)/sizeof(TCC893X_GPB_init_tbl[0])) ; i++)
		gpio_config(TCC893X_GPB_init_tbl[i].port, TCC893X_GPB_init_tbl[i].function|TCC893X_GPB_init_tbl[i].direction|TCC893X_GPB_init_tbl[i].pull);

	for(i=0 ; i<(sizeof(TCC893X_GPC_init_tbl)/sizeof(TCC893X_GPC_init_tbl[0])) ; i++)
		gpio_config(TCC893X_GPC_init_tbl[i].port, TCC893X_GPC_init_tbl[i].function|TCC893X_GPC_init_tbl[i].direction|TCC893X_GPC_init_tbl[i].pull);

	for(i=0 ; i<(sizeof(TCC893X_GPD_init_tbl)/sizeof(TCC893X_GPD_init_tbl[0])) ; i++)
		gpio_config(TCC893X_GPD_init_tbl[i].port, TCC893X_GPD_init_tbl[i].function|TCC893X_GPD_init_tbl[i].direction|TCC893X_GPD_init_tbl[i].pull);

	for(i=0 ; i<(sizeof(TCC893X_GPE_init_tbl)/sizeof(TCC893X_GPE_init_tbl[0])) ; i++)
		gpio_config(TCC893X_GPE_init_tbl[i].port, TCC893X_GPE_init_tbl[i].function|TCC893X_GPE_init_tbl[i].direction|TCC893X_GPE_init_tbl[i].pull);

	for(i=0 ; i<(sizeof(TCC893X_GPF_init_tbl)/sizeof(TCC893X_GPF_init_tbl[0])) ; i++)
		gpio_config(TCC893X_GPF_init_tbl[i].port, TCC893X_GPF_init_tbl[i].function|TCC893X_GPF_init_tbl[i].direction|TCC893X_GPF_init_tbl[i].pull);

	for(i=0 ; i<(sizeof(TCC893X_GPG_init_tbl)/sizeof(TCC893X_GPG_init_tbl[0])) ; i++)
		gpio_config(TCC893X_GPG_init_tbl[i].port, TCC893X_GPG_init_tbl[i].function|TCC893X_GPG_init_tbl[i].direction|TCC893X_GPG_init_tbl[i].pull);

	for(i=0 ; i<(sizeof(TCC893X_GPHDMI_init_tbl)/sizeof(TCC893X_GPHDMI_init_tbl[0])) ; i++)
		gpio_config(TCC893X_GPHDMI_init_tbl[i].port, TCC893X_GPHDMI_init_tbl[i].function|TCC893X_GPHDMI_init_tbl[i].direction|TCC893X_GPHDMI_init_tbl[i].pull);

	for(i=0 ; i<(sizeof(TCC893X_GPADC_init_tbl)/sizeof(TCC893X_GPADC_init_tbl[0])) ; i++)
		gpio_config(TCC893X_GPADC_init_tbl[i].port, TCC893X_GPADC_init_tbl[i].function|TCC893X_GPADC_init_tbl[i].direction|TCC893X_GPADC_init_tbl[i].pull);
