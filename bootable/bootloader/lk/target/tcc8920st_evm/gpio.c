...
#if defined(TARGET_BOARD_STB) && (HW_REV < 0x7000)
...
#else
	{ TCC_GPC(22) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, //MEMQZQ_ON
#endif
...
#if defined(TARGET_TCC8925_STB_DONGLE) && (HW_REV != 0x9112)
...
#if defined(TARGET_TCC8925_UPC)
	{ TCC_GPE(19) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH , GPIO_PULLDISABLE },
#else
...
#if (HW_REV == 0x9112)
	{ TCC_GPF(26) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLUP },	     // debug console uart rx
#else
...
#if (HW_REV == 0x7100) || (HW_REV == 0x7110) //For Yaojin V3.0
	{ TCC_GPG(14) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH , GPIO_PULLDISABLE },
#else
