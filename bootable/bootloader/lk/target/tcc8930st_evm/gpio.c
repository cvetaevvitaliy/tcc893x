...
struct gpio_cfg TCC8930_GPB_init_tbl[] = {
...
#if defined(TARGET_BOARD_STB) && !defined(TARGET_TCC8933_YJ8933T)
	...
	{ TCC_GPB(22) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE },
	#else
...
#if defined(TARGET_TCC8930_YJ8930T) && (HW_REV == 0x7231)
	{ TCC_GPB(30) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH , GPIO_PULLDISABLE }, //CORE_CTL
#else
...
struct gpio_cfg TCC8930_GPC_init_tbl[] = {
	...
	{ TCC_GPC(24) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, //VDDQ_MEM_ON
#else
...
#if defined(CONFIG_CHIP_TCC8935S) && defined(TARGET_TCC8935_DONGLE) && (HW_REV != 0x9313)
	{ TCC_GPD(11) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH , GPIO_PULLDISABLE },
#else
        { TCC_GPD(11) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#endif
	{ TCC_GPD(12) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#if defined(TARGET_TCC8935_YJ8935T)
	{ TCC_GPD(13) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, //OTG0_MODE_SET
#else
...
#if defined(TARGET_TCC8935_UPC) || (defined(TARGET_TCC8935_DONGLE) && HW_REV != 0x9312)
	{ TCC_GPD(22) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE },
#else
	{ TCC_GPD(22) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#endif
#if defined(TARGET_TCC8930_EV)
	{ TCC_GPD(23) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE },
#else
...
struct gpio_cfg TCC8930_GPE_init_tbl[] = {
...
#if defined(CONFIG_CHIP_TCC8935S) && defined(TARGET_TCC8935_DONGLE) && (HW_REV == 0x9313)
        { TCC_GPE(13) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH , GPIO_PULLDISABLE },
#else
	{ TCC_GPE(13) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#endif
	{ TCC_GPE(14) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#if defined(TARGET_TCC8935_UPC)
	{ TCC_GPE(15) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH , GPIO_PULLDISABLE },
#else
	{ TCC_GPE(15) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#endif
#if !defined(CONFIG_CHIP_TCC8935S) && defined(TARGET_TCC8935_DONGLE)
	{ TCC_GPE(16) ,GPIO_FN0 , GPIO_INPUT , GPIO_PULLDISABLE },
#else
        { TCC_GPE(16) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#endif
	{ TCC_GPE(17) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#if defined(TARGET_TCC8935_DONGLE) && (HW_REV == 0x9312)
        { TCC_GPE(18) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE },
#else
	...
	{ TCC_GPE(27) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, //PMIC_IRQ(0x2000)
...
struct gpio_cfg TCC8930_GPF_init_tbl[] = {
...
#if defined(TARGET_TCC8935_DONGLE) && ((HW_REV == 0x9312) || (HW_REV == 0x9313))
        { TCC_GPF(4)  ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE },
#else
...
#if defined(TARGET_TCC8935_YJ8935T) || defined(TARGET_TCC8933_YJ8933T)
	...
	#if defined(TARGET_BOARD_STB)
	{ TCC_GPF(9)  ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, //SLEEP_MODE_CTRL
	#else
	{ TCC_GPF(9)  ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
	#endif
#endif
...
#if defined(TARGET_TCC8935_YJ8935T) || defined(TARGET_TCC8933_YJ8933T) || defined(TARGET_TCC8935_DONGLE)
	{ TCC_GPF(25) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLUP },
	{ TCC_GPF(26) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLUP },
#else
	...
	{ TCC_GPF(29) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
   	...
   	{ TCC_GPF(30) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLUP },
	{ TCC_GPF(31) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLUP },
#else    
...
struct gpio_cfg TCC8930_GPG_init_tbl[] = {
...
#if defined(TARGET_TCC8935_YJ8935T)
	{ TCC_GPG(14) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, //CORE_CTL
	...
	{ TCC_GPG(14) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, //CORE_CTL
	{ TCC_GPG(15) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH , GPIO_PULLDISABLE }, //CPU_CTL1
	{ TCC_GPG(16) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH , GPIO_PULLDISABLE }, //CPU_CTL2
#elif defined(TARGET_TCC8935_UPC)
	{ TCC_GPG(14) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE }, //CORE_PWR : 1.2V
	{ TCC_GPG(15) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, //CPU_PWR : 1.4V
	{ TCC_GPG(16) ,GPIO_FN0 , GPIO_INPUT           , GPIO_PULLDISABLE },
#elif defined(TARGET_TCC8935_DONGLE)
	{ TCC_GPG(14) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, //CORE_CTL1
	{ TCC_GPG(15) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, //CORE_CTL0
	{ TCC_GPG(16) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#elif defined(TARGET_TCC8930_YJ8930T) && (HW_REV == 0x7230)
	{ TCC_GPG(14) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH , GPIO_PULLDISABLE }, //CORE_CTL
	{ TCC_GPG(15) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
	{ TCC_GPG(16) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#else	
...
#if defined(TARGET_BOARD_STB)
	{ TCC_GPHDMI(1)  ,GPIO_FN1 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#else
