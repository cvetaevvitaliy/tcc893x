...
#elif (HW_REV == 0x2003) || (HW_REV == 0x2004) || (HW_REV == 0x2005) || (HW_REV == 0x2006) || (HW_REV == 0x2007)
	{ TCC_GPC(13) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE }, //PMU_HOLD
	{ TCC_GPC(14) ,GPIO_FN0 , GPIO_INPUT           , GPIO_PULLDISABLE }, //PMU_BATDET
#else	// 0x2000, 0x2001, 0x2008
	{ TCC_GPC(13) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#if (HW_REV == 0x2000) || (HW_REV == 0x2001) || (HW_REV == 0x2008)
	{ TCC_GPC(14) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLDISABLE },
#else	// 0x2009
	{ TCC_GPC(14) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH, GPIO_PULLDISABLE },
#endif
#endif
...
#else	// 0x2001, 0x2002, 0x2003, 0x2004, 0x2005, 0x2006, 0x2007, 0x2008
...
struct gpio_cfg TCC8923_GPE_init_tbl[] = {
	...
	{ TCC_GPE(26) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_HIGH , GPIO_PULLDISABLE },
#if (HW_REV == 0x2000) || (HW_REV == 0x2001)
...
struct gpio_cfg TCC8923_GPG_init_tbl[] = {
	...
	{ TCC_GPG(18) ,GPIO_FN0 , GPIO_OUTPUT|GPIO_LOW , GPIO_PULLUP      }, // Bluetooth RX port
