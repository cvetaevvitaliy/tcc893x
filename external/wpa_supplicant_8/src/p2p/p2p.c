...
void p2p_go_complete(struct p2p_data *p2p, struct p2p_device *peer)
{
	...
	int freqs;
	size_t i, j;
	int best_5g = 1, num_5g=0, num_2g=0, pick; // terence 20121225: set GO channel to 5G if GC/GO support 5G channel
