...
void get_p2p_interface_replacement(const char *interface, char *p2p_interface) {
    ALOGD("%s interface = %s p2p_interface = %s", __FUNCTION__, interface, p2p_interface);
                     ...
                     char *mtu)
{
    ...
    ALOGD("%s interface = %s ipaddr = %s", __FUNCTION__, interface, ipaddr);
                    ...
                    char *mtu)
{
    ...
    ALOGD("%s interface = %s p2p_interface = %s ipaddr = %s", __FUNCTION__, interface, p2p_interface, ipaddr);
    ...
    ALOGD("%s daemon_cmd = %s", __FUNCTION__, daemon_cmd);
    memset(prop_value, '\0', PROPERTY_VALUE_MAX);
    property_set(ctrl_prop, daemon_cmd);
