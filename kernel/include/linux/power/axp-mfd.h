...
#define AXP_VOFF_SET							POWER20_VOFF_SET
...
extern int axp_update(struct i2c_client *client, int reg, uint8_t val, uint8_t mask);
extern int axp_set_bits(struct i2c_client *client, int reg, uint8_t bit_mask);
extern int axp_clr_bits(struct i2c_client *client, int reg, uint8_t bit_mask);
