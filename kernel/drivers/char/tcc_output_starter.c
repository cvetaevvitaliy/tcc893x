...
static char default_component_resolution = STARTER_COMPONENT_720P;
...
void tcc_output_starter_hdmi(unsigned char lcdc_num, unsigned char hdmi_resolution)
{
	...
	tca_ckc_setippwdn(PMU_ISOL_HDMI, 0);
 	tca_ckc_setperi(PERI_HDMI, ENABLE, HDMI_CLK_RATE);
...
void tcc_output_starter_component(unsigned char lcdc_num, unsigned char type)
{
	...
	DPRINTF("LCDC0 clk:%d, LCDC1 clk:%d\n", tca_ckc_getperi(PERI_LCD0), tca_ckc_getperi(PERI_LCD1));
...
//	VIOC_WMIX_SetOverlayPriority(pWMIX, 0);
	...
	if(type == STARTER_COMPONENT_480I_NTSC)
		...
		ths8200_enable(COMPONENT_MODE_720P, 1);
	else if(type == STARTER_COMPONENT_1080I)
		ths8200_enable(COMPONENT_MODE_1080I, 1);
	else
		cs4954_enable(COMPONENT_MODE_NTSC_M);
...
int __init tcc_output_starter_init(void)
{
	...
	major_id = register_chrdev(0, DEVICE_NAME, &tcc_output_starter_fops);
	...
	pmap_get_info("output_attach", &pmap_attach);
		...
		tcc_output_starter_hdmi(lcdc_1st, tcc_display_data.hdmi_resolution);
		/* 2nd Output Setting */
		TCC_OUTPUT_FB_AttachOutput(lcdc_1st, TCC_OUTPUT_HDMI, TCC_OUTPUT_COMPOSITE, tcc_display_data.composite_resolution, 1);
		...
		else
		{
			...
			/* 2nd Output Setting */
			TCC_OUTPUT_FB_AttachOutput(lcdc_1st, TCC_OUTPUT_COMPONENT, TCC_OUTPUT_COMPOSITE, tcc_display_data.composite_resolution, 1);
		}
	#else
		tcc_output_starter_hdmi(lcdc_1st, tcc_display_data.hdmi_resolution);
	#endif
