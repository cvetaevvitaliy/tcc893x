...
void tcc_gmac_enable_dma_ch0_transmission(unsigned long ioaddr)
{
	writel(1, ioaddr + DMA_CH0_XMT_POLL_DEMAND);
}

void tcc_gmac_enable_dma_ch1_transmission(unsigned long ioaddr)
{
	writel(1, ioaddr + DMA_CH1_XMT_POLL_DEMAND);
}

void tcc_gmac_enable_dma_ch2_transmission(unsigned long ioaddr)
{
...
void tcc_gmac_enable_dma_ch0_irq(unsigned long ioaddr)
{
	writel(DMA_INTR_DEFAULT_MASK, ioaddr + DMA_CH0_INTR_ENA);
}

void tcc_gmac_enable_dma_ch1_irq(unsigned long ioaddr)
{
	writel(DMA_INTR_DEFAULT_MASK, ioaddr + DMA_CH1_INTR_ENA);
}

void tcc_gmac_enable_dma_ch2_irq(unsigned long ioaddr)
{
...
void tcc_gmac_disable_dma_ch0_irq(unsigned long ioaddr)
{
	writel(0, ioaddr + DMA_CH0_INTR_ENA);
}

void tcc_gmac_disable_dma_ch1_irq(unsigned long ioaddr)
{
	writel(0, ioaddr + DMA_CH1_INTR_ENA);
}

void tcc_gmac_disable_dma_ch2_irq(unsigned long ioaddr)
{
...
void tcc_gmac_dma_ch0_start_tx(unsigned long ioaddr)
{
...
void tcc_gmac_dma_ch1_start_tx(unsigned long ioaddr)
{
...
void tcc_gmac_dma_ch2_start_tx(unsigned long ioaddr)
{
...
void tcc_gmac_dma_ch0_stop_tx(unsigned long ioaddr)
{
	u32 value = readl(ioaddr + DMA_CH0_CONTROL);
	value &= ~DMA_CONTROL_ST;
	writel(value, ioaddr + DMA_CH0_CONTROL);
...
void tcc_gmac_dma_ch1_stop_tx(unsigned long ioaddr)
{
	u32 value = readl(ioaddr + DMA_CH1_CONTROL);
	value &= ~DMA_CONTROL_ST;
	writel(value, ioaddr + DMA_CH1_CONTROL);
...
void tcc_gmac_dma_ch2_stop_tx(unsigned long ioaddr)
{
	u32 value = readl(ioaddr + DMA_CH2_CONTROL);
	value &= ~DMA_CONTROL_ST;
	writel(value, ioaddr + DMA_CH2_CONTROL);
...
void tcc_gmac_dma_ch0_start_rx(unsigned long ioaddr)
{
	u32 value = readl(ioaddr + DMA_CH0_CONTROL);
...
void tcc_gmac_dma_ch1_start_rx(unsigned long ioaddr)
{
	u32 value = readl(ioaddr + DMA_CH1_CONTROL);
	value |= DMA_CONTROL_SR;
	writel(value, ioaddr + DMA_CH1_CONTROL);
...
void tcc_gmac_dma_ch2_start_rx(unsigned long ioaddr)
{
	u32 value = readl(ioaddr + DMA_CH2_CONTROL);
	value |= DMA_CONTROL_SR;
	writel(value, ioaddr + DMA_CH2_CONTROL);
...
void tcc_gmac_dma_ch0_stop_rx(unsigned long ioaddr)
{
	u32 value = readl(ioaddr + DMA_CH0_CONTROL);
	value &= ~DMA_CONTROL_SR;
	writel(value, ioaddr + DMA_CH0_CONTROL);
...
void tcc_gmac_dma_ch1_stop_rx(unsigned long ioaddr)
{
	u32 value = readl(ioaddr + DMA_CH1_CONTROL);
	value &= ~DMA_CONTROL_SR;
	writel(value, ioaddr + DMA_CH1_CONTROL);
...
void tcc_gmac_dma_ch2_stop_rx(unsigned long ioaddr)
{
	u32 value = readl(ioaddr + DMA_CH2_CONTROL);
	value &= ~DMA_CONTROL_SR;
	writel(value, ioaddr + DMA_CH2_CONTROL);
...
int tcc_gmac_dma_interrupt(unsigned long dma_base, struct tcc_gmac_extra_stats *x)
{
	int ret = 0;
...
int tcc_gmac_dma_ch0_interrupt(unsigned long ioaddr, struct tcc_gmac_extra_stats *x)
{
	return tcc_gmac_dma_interrupt(ioaddr + DMA_CH0_OFFSET, x);
}

int tcc_gmac_dma_ch1_interrupt(unsigned long ioaddr, struct tcc_gmac_extra_stats *x)
{
	return tcc_gmac_dma_interrupt(ioaddr + DMA_CH1_OFFSET, x);
}

int tcc_gmac_dma_ch2_interrupt(unsigned long ioaddr, struct tcc_gmac_extra_stats *x)
{
...
void tcc_gmac_dma_slot_control(unsigned long dma_base, bool enable, bool advance)
{
...
void tcc_gmac_dma_ch1_slot_control(unsigned long ioaddr, bool enable, bool advance)
{
	tcc_gmac_dma_slot_control(ioaddr + DMA_CH1_OFFSET, enable, advance);
}

void tcc_gmac_dma_ch2_slot_control(unsigned long ioaddr, bool enable, bool advance)
{
...
void tcc_gmac_dma_ch1_disable_slot_interrupt(unsigned long ioaddr)
{
...
void tcc_gmac_dma_ch2_disable_slot_interrupt(unsigned long ioaddr)
{
	unsigned int cbs_control;
...
void tcc_gmac_dma_ch1_enable_slot_interrupt(unsigned long ioaddr)
{
	unsigned int cbs_control;
...
void tcc_gmac_dma_ch2_enable_slot_interrupt(unsigned long ioaddr)
{
	unsigned int cbs_control;
...
//////////////////////////////////////////////////////////
void tcc_gmac_dma_cbs_control(unsigned long ioaddr,
...
void tcc_gmac_dma_ch1_cbs_control(unsigned long ioaddr,
			bool enable, bool credit_control, unsigned int slot_count, bool abpssie)
{
	tcc_gmac_dma_cbs_control(ioaddr + DMA_CH1_OFFSET, enable, credit_control, slot_count, abpssie);
}

void tcc_gmac_dma_ch2_cbs_control(unsigned long ioaddr,
			bool enable, bool credit_control, unsigned int slot_count, bool abpssie)
{
...
unsigned int tcc_gmac_dma_ch1_cbs_status(unsigned long ioaddr)
{
	return readl(ioaddr + DMA_CH1_CBS_STATUS);
}

unsigned int tcc_gmac_dma_ch2_cbs_status(unsigned long ioaddr)
{
...
void tcc_gmac_dma_ch1_idle_slope_credit(unsigned long ioaddr, unsigned int bits_per_cycle)
{
	writel(bits_per_cycle & 0x3fff, ioaddr + DMA_CH1_IDLE_SLOPE_CREDIT);
}

void tcc_gmac_dma_ch2_idle_slope_credit(unsigned long ioaddr, unsigned int bits_per_cycle)
{
...
void tcc_gmac_dma_ch1_send_slope_credit(unsigned long ioaddr, unsigned int bits_per_cycle)
{
	writel(bits_per_cycle & 0x3fff, ioaddr + DMA_CH1_SEND_SLOPE_CREDIT);
}

void tcc_gmac_dma_ch2_send_slope_credit(unsigned long ioaddr, unsigned int bits_per_cycle)
{
...
void tcc_gmac_dma_ch1_hi_credit(unsigned long ioaddr, unsigned int credit)
{
	writel(credit& 0x1fffffff, ioaddr + DMA_CH1_HI_CREDIT);
}

void tcc_gmac_dma_ch2_hi_credit(unsigned long ioaddr, unsigned int credit)
{
...
void tcc_gmac_dma_ch1_lo_credit(unsigned long ioaddr, unsigned int credit)
{
	writel(credit& 0x1fffffff, ioaddr + DMA_CH1_LO_CREDIT);
}

void tcc_gmac_dma_ch2_lo_credit(unsigned long ioaddr, unsigned int credit)
{
...
static int tcc_gmac_dma_init(unsigned long dma_base, int pbl, u32 dma_tx,
			      u32 dma_rx)
{
...
static int tcc_gmac_dma_ch0_init(unsigned long ioaddr, int pbl, u32 dma_tx,
			      u32 dma_rx)
{
...
static int tcc_gmac_dma_ch1_init(unsigned long ioaddr, int pbl, u32 dma_tx,
			      u32 dma_rx)
{
...
static int tcc_gmac_dma_ch2_init(unsigned long ioaddr, int pbl, u32 dma_tx,
			      u32 dma_rx)
{
...
static void tcc_gmac_dma_set_bus_mode(unsigned long dma_base, u32 prwg, u32 txpr, u32 pr, u32 da)
{
	u32 bus_mode;
...
static void tcc_gmac_dma_ch0_set_bus_mode(unsigned long ioaddr, u32 prwg, u32 txpr, u32 pr, u32 da)
{
	tcc_gmac_dma_set_bus_mode(ioaddr+DMA_CH0_OFFSET, prwg, txpr, pr, da);
}

static void tcc_gmac_dma_ch1_set_bus_mode(unsigned long ioaddr, u32 prwg, u32 txpr, u32 pr, u32 da)
{
	tcc_gmac_dma_set_bus_mode(ioaddr+DMA_CH1_OFFSET, prwg, txpr, pr, da);
}

static void tcc_gmac_dma_ch2_set_bus_mode(unsigned long ioaddr, u32 prwg, u32 txpr, u32 pr, u32 da)
{
...
static void tcc_gmac_dma_operation_mode(unsigned long dma_base, int txmode,
				    int rxmode)
{
...
static void tcc_gmac_dma_ch0_operation_mode(unsigned long ioaddr, int txmode,
				    int rxmode)
{
...
static void tcc_gmac_dma_ch1_operation_mode(unsigned long ioaddr, int txmode,
				    int rxmode)
{
...
static void tcc_gmac_dma_ch2_operation_mode(unsigned long ioaddr, int txmode,
				    int rxmode)
{
...
static void tcc_gmac_dump_dma_ch0_regs(unsigned long ioaddr)
{
	int i;
...
static void tcc_gmac_dump_dma_ch1_regs(unsigned long ioaddr)
{
	int i;
	int offset;
...
static void tcc_gmac_dump_dma_ch2_regs(unsigned long ioaddr)
{
	int i;
	int offset;
...
static void tcc_gmac_timestamp_irq_enable(unsigned long ioaddr)
{
...
static void tcc_gmac_timestamp_irq_disable(unsigned long ioaddr)
{
	unsigned int intr_mask;
...
static void tcc_gmac_set_av_ethertype(unsigned long ioaddr, unsigned int ethertype)
{
...
static void tcc_gmac_set_av_priority(unsigned long ioaddr, unsigned int priority)
{
	unsigned int av_mac_control;
...
static void tcc_gmac_set_av_avch(unsigned long ioaddr, unsigned int avch)
{
	unsigned int av_mac_control;
...
static void tcc_gmac_set_av_ptpch(unsigned long ioaddr, unsigned int ptpch)
{
	unsigned int av_mac_control;
...
static void tcc_gmac_ptp_set_ssinc(unsigned long ioaddr, unsigned int ssinc)
{
	writel(ssinc, ioaddr + GMAC_SUB_SECOND_INCREMENT);
}

static void tcc_gmac_ptp_digital_rollover_enable(unsigned long ioaddr)
{
...
static void tcc_gmac_ptp_digital_rollover_disable(unsigned long ioaddr)
{
	unsigned int ts_control;
...
static void tcc_gmac_ptp_enable(unsigned long ioaddr)
{
	unsigned int ts_control;
...
static void tcc_gmac_ptp_disable(unsigned long ioaddr)
{
	unsigned int ts_control;
...
static void tcc_gmac_ptp_pps0_trig_enable(unsigned ioaddr)
{
...
static void tcc_gmac_ptp_pps0_trig_disable(unsigned ioaddr)
{
	unsigned int pps_control;
...
static void tcc_gmac_ptp_pps0_set_time(unsigned long ioaddr, u32 sec, u32 nsec)
{
...
static void tcc_gmac_ptp_trig_irq_enable(unsigned long ioaddr)
{
	unsigned int ts_control;
...
static void tcc_gmac_ptp_trig_irq_disable(unsigned long ioaddr)
{
	unsigned int ts_control;
...
static int tcc_gmac_ptp_update_system_time(unsigned long ioaddr,
...
static int tcc_gmac_get_system_time(unsigned long ioaddr, struct timespec *time)
{
...
static int tcc_gmac_set_system_time(unsigned long ioaddr, u32 sec, u32 nsec)
{
	int i;
	unsigned int ts_control;
...
static int tcc_gmac_ptp_snapshot_mode(unsigned long ioaddr, u32 rx_filter)
{
	unsigned int ts_control;
...
static int tcc_gmac_ptp_timestamp_init(unsigned long ioaddr, u32 sec, u32 nsec)
{
	int i;
...
struct mac_device_info *tcc_gmac_setup(unsigned long ioaddr, unsigned int bus_clk_rate)
{
