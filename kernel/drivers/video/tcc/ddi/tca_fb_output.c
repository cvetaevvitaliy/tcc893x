...
static struct clk *scaler1_clk = NULL;	 	// video image scale
static struct clk *scaler0_clk = NULL;		// fb image scale
static struct clk *lcdc0_output_clk = NULL;
static struct clk *lcdc1_output_clk = NULL;
static struct clk *g2d_clk = NULL;
...
void TCC_OUTPUT_LCDC_Init(void)
{
	...
	if (IS_ERR(scaler1_clk))
		scaler1_clk = NULL;

	scaler0_clk = clk_get(0, "m2m0");
	if (IS_ERR(scaler0_clk))
		scaler0_clk = NULL
