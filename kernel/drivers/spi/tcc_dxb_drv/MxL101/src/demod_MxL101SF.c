...
void MxL101SF_Init(void)
{
 ...
 // MXL_SIGNAL_STATS_T sigStrength;
  ...
  mxlMpegOutCfg.MpegClkFreq = MPEG_CLOCK_9_142857MHz;//MPEG_CLOCK_9_142857MHz;//MPEG_CLOCK_36_571429MHz;
  mxlMpegOutCfg.LsbOrMsbFirst = MPEG_SERIAL_MSB_1ST;
  mxlMpegOutCfg.MpegClkPhase = MPEG_CLK_INVERTED;//MPEG_CLK_IN_PHASE;//MPEG_CLK_IN_PHASE;
