...
{
	if(machine_is_tcc8800() || machine_is_tcc8920() || machine_is_tcc893x() || machine_is_m805_893x()){
...
#elif defined(CONFIG_ARCH_TCC892X)|| defined(CONFIG_CHIP_TCC8935S) || defined(CONFIG_CHIP_TCC8933S) || defined(CONFIG_CHIP_TCC8937S)
