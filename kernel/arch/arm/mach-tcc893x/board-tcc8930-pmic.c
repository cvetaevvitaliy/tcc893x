...
#if defined(CONFIG_REGULATOR_TCC270)
	tcc270_dcdc1_info.num_consumer_supplies = 1;
	tcc270_dcdc1_info.consumer_supplies = &consumer_cpu;
	tcc270_dcdc2_info.num_consumer_supplies = 1;
	tcc270_dcdc2_info.consumer_supplies = &consumer_core;
#endif
