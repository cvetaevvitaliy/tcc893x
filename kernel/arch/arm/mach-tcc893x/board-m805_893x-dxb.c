...
static void tcc_dxb_init(void)
{
	if(machine_is_m805_893x())
	{
		...
		tcc_gpio_config(GPIO_DXB1_SFRM, GPIO_FN(0)|GPIO_PULLUP);
		gpio_request(GPIO_DXB1_SFRM, NULL);
		gpio_direction_input(GPIO_DXB1_SFRM);

		tcc_gpio_config(GPIO_DXB1_SCLK, GPIO_FN(0)|GPIO_PULLUP);
		gpio_request(GPIO_DXB1_SCLK, NULL);
		gpio_direction_input(GPIO_DXB1_SCLK);

		tcc_gpio_config(GPIO_DXB1_SDI, GPIO_FN(0)|GPIO_PULLUP);
		gpio_request(GPIO_DXB1_SDI, NULL);
		gpio_direction_input(GPIO_DXB1_SDI);

		tcc_gpio_config(GPIO_DXB1_SDO, GPIO_FN(0)|GPIO_PULLUP);
