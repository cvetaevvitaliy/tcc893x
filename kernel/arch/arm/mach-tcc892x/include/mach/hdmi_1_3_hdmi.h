/****************************************************************************
 * FileName    : kernel/arch/arm/mach-tcc893x/include/mach/hdmi_1_3_hdmi.h
...
#define HDMI_IOC_SET_COLORIMETRY			_IOW(HDMI_IOC_MAGIC,22,enum HDMIColorimetry)
...
#define HDMI_IOC_GET_SUSPEND_STATUS				_IOR(HDMI_IOC_MAGIC,33, unsigned int)
