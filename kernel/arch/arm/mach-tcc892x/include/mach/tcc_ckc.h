...
#ifndef _MACH_TCC_CKC_H_
#define _MACH_TCC_CKC_H_
...
extern int          tcc_find_pms(tPMS *PLL);
extern unsigned int tca_ckc_setpll(unsigned int fpll, unsigned int ch);  /* pll(100Hz) */
