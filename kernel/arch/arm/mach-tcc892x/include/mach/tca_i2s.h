...
#if defined(CONFIG_CHIP_TCC8923) || defined(CONFIG_CHIP_TCC8925) || defined(CONFIG_CHIP_TCC8925S)
...
#elif defined(CONFIG_CHIP_TCC8925S) // Planet 20121025 SPDIF exists only on channel01
