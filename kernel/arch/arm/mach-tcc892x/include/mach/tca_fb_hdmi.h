...
extern int TCC_HDMI_LAST_FRAME_UPDATE(char hdmi_lcdc, struct tcc_lcdc_image_update *ImageInfo);
extern void TCC_HDMI_PREV_FRAME_OFF(char hdmi_lcdc, int interlace_onthefly_mode);
#endif
