...
struct platform_device tcc8920_spi1_device = {
	.name		= "tcc-spi",
	.id			= 1,
...
static struct resource tsif_ex_resources[] = {
	...
	[2] = {
        .name   = "tsif0",
#if   defined(CONFIG_MACH_TCC8920ST) || defined(CONFIG_CHIP_TCC8925) || defined(CONFIG_CHIP_TCC8925S)
...
static int __init tcc892x_init_devices(void)
{
    ...
    {
        //tcc8925
        tsif_resources[2].start = 12; /* Port12 GPIO_E[12:15] */
        tsif_resources[2].end = 12;
