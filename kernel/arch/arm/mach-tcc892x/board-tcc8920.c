...
static struct i2c_board_info __initdata i2c_devices1[] = {
	...
	{
		I2C_BOARD_INFO("tcc-ts-ilitek", 0x41),
		.irq = INT_EI2,
		.platform_data = NULL,
	},
#endif
...
extern int __init tcc8920_init_battery(void);
#endif
...
static void __init tcc8920_init_machine(void)
{
	...
	spi_register_board_info(tcc8920_spi1_board_info, ARRAY_SIZE(tcc8920_spi1_board_info));
#endif
...
#endif
#if defined(CONFIG_TCC_UART4_DMA)
	platform_device_add_data(&tcc8920_uart4_device, &uart4_data, sizeof(struct tcc_uart_platform_data));
#endif
#if defined(CONFIG_TOUCHSCREEN_TCCTS) || defined(CONFIG_TOUCHSCREEN_TCCTS_MODULE)
