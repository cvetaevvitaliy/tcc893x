...
{
	if (sc_io.pwren != -1) {
#if defined(CONFIG_MACH_TCC8920) || defined(CONFIG_MACH_TCC8920ST) || defined(CONFIG_MACH_TCC8925)
...
#if defined (CONFIG_CHIP_TCC8920)
...
#elif defined (CONFIG_CHIP_TCC8925)
	sc_io.rst = TCC_GPEXT2(6);		//active-low
