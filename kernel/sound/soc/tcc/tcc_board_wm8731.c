...
#if !defined(CONFIG_SND_TCC_DAI2SPDIF)
//#if defined(CONFIG_ARCH_TCC892X) || defined(CONFIG_ARCH_TCC893X) || defined(CONFIG_CHIP_TCC8925S) // Planet 20121025 SPDIF exists only on channel01
...
static int __init tcc_init_wm8731(void)
{
    ...
    if( 0 ){ //!(machine_is_tcc8800() || machine_is_tcc8920() || machine_is_tcc893x() ) ) {
        alsa_dbg("\n\n\n\n%s() do not execution....\n\n", __func__);
        return 0;
    }
