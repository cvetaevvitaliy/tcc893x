...
#if defined(TCC_AUDIO_WM8731)
#define MIXER_XML_PATH "/system/etc/mixer_paths_wm8731.xml"
#elif defined(TCC_AUDIO_ES8388)
#define MIXER_XML_PATH "/system/etc/mixer_paths_es8388.xml"
#elif defined(TCC_AUDIO_WM8988)
#define MIXER_XML_PATH "/system/etc/mixer_paths_wm8988.xml"
#elif defined(TCC_AUDIO_WM8524) 
#define MIXER_XML_PATH "/system/etc/mixer_paths_wm8524.xml"
#elif defined(TCC_AUDIO_RT5633)
#define MIXER_XML_PATH "/system/etc/mixer_paths_rt5633.xml"
#elif defined(TCC_AUDIO_RT5631)
#define MIXER_XML_PATH "/system/etc/mixer_paths_rt5631.xml"
#elif defined(TCC_AUDIO_RT5625)
#define MIXER_XML_PATH "/system/etc/mixer_paths_rt5625.xml"
#else
#error "Need to define the type of audio codec"
#endif
