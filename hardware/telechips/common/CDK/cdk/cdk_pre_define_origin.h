...
//	#endif
    ...
    #if defined(TCC_8935S_INCLUDE) || defined(TCC_8925S_INCLUDE)
        #define INCLUDE_JPU_MJPEG_DEC
    #endif
...
#define STYLE_RESET		T_DEFAULT
	...
	//#define DBG_VPU_IFRAMESEARCHMODE //-vdecopt 0x2000(8192)
	//#define DBG_VPU_FRAMEBUFF_DELAY  //-vdecopt 0x4000(16384) or 0xC000(49152)
