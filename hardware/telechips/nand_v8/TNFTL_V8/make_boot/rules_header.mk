...
DEF_CODE_GEN := -fno-strict-aliasing -fno-builtin -fno-common -fno-omit-frame-pointer -fno-optimize-sibling-calls
...
all: $(DEF_TARGET)
	cp $(DEF_TARGET) ../../../../../bootable/bootloader/lk/platform/$(TCC_PLATFORM)/libs/
