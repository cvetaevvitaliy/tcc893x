...
#define NAND_INIT_WHOLE_AREA			0
#define NAND_INIT_RO_ONLY				1
...
extern int NAND_WriteFirmware_For_TCC800X( unsigned int uiDrvNum, unsigned char *pucRomBuffer, unsigned int uiRomFileSize );
extern int NAND_Flush_Cacheblock(unsigned int uiDrvNum);
extern int NAND_Padding_Cacheblock(unsigned int uiDrvNum);
