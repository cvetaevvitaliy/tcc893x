...
#define VIDEO_DEC_VP8_SW_NAME "OMX.TCC.google.vp8dec"
#define VIDEO_DEC_VP8_SW_ROLE "google_vpx_decoder.vp8"

#define VIDEO_DEC_VP9_NAME "OMX.TCC.vp9dec"
#define VIDEO_DEC_VP9_ROLE "video_decoder.vp9"
#define VIDEO_DEC_VP9_SW_NAME "OMX.TCC.google.vp9dec"
#define VIDEO_DEC_VP9_SW_ROLE "google_vpx_decoder.vp9"
...
/* Clock Role Definition */
#define CLOCK_NAME	"OMX.TCC.clock"
#define CLOCK_ROLE	"clock.binary"

/* Video related Role Def */
#define VIDEO_PROCESSOR_NAME "OMX.TCC.video_processor"
#define VIDEO_PROCESSOR_ROLE "iv_processor.yuv"

#define VIDEO_SCHEDULER_NAME "OMX.TCC.video_scheduler"
#define VIDEO_SCHEDULER_ROLE "video_scheduler.binary"

/* Renderer Role Def */
#define VIDEO_RENDERER_NAME "OMX.TCC.video_renderer"
#define VIDEO_RENDERER_ROLE "video_renderer.yuv.overlay"

#define AUDIO_RENDERER_NAME "OMX.TCC.audio_scheduler"
#define AUDIO_RENDERER_ROLE "audio_renderer.pcm"
...
typedef enum BUFFER_TYPE
{
	...
	DecoderMetadataPtr      /*Used when buffer pointers which come from IndexDecoderStoreMetadatInBuffers usecase*/
} BUFFER_TYPE;
