...
#ifdef OPENMAX1_2
      (omx_base_sink_Private->state != OMX_StateLoaded && omx_base_sink_Private->state != OMX_StateReserved_0x00000000)) {
#else
...
#ifdef OPENMAX1_2
    if(omx_base_sink_Private->state == OMX_StateLoaded || omx_base_sink_Private->state == OMX_StateReserved_0x00000000) {
#else
