...
OMX_ERRORTYPE omx_base_component_Destructor(OMX_COMPONENTTYPE *openmaxStandComp) {
  ...
  DEBUG(DEB_LEV_FUNCTION_NAME, "In %s\n", __func__);
#ifdef OPENMAX1_2
  omx_base_component_Private->state = OMX_StateReserved_0x00000000;
#else
...
#ifdef OPENMAX1_2
  if(destinationState == OMX_StateReserved_0x00000000) {
    switch(omx_base_component_Private->state) {
    case OMX_StateReserved_0x00000000:
      err = OMX_ErrorReserved_0x8000100A;
      break;
...
#ifdef HAVE_ANDROID_OS
OMX_ERRORTYPE omx_base_component_Allocate_SecuredInBuffer(
            OMX_IN OMX_HANDLETYPE hComponent,
            OMX_INOUT OMX_BUFFERHEADERTYPE** ppBuffer,
            OMX_IN OMX_U32 nPortIndex,
            OMX_IN OMX_PTR pAppPrivate,
            OMX_IN OMX_U32 nSizeBytes,
            OMX_IN OMX_U32 nStartAddr,
            OMX_IN OMX_U32 nActualSizebytes) {
  omx_base_component_PrivateType* omx_base_component_Private = (omx_base_component_PrivateType*)((OMX_COMPONENTTYPE*)hComponent)->pComponentPrivate;
  omx_base_PortType *pPort;
  ...
  return pPort->Port_Allocate_SecuredInBuffer(pPort,
                                    ppBuffer,
                                    nPortIndex,
                                    pAppPrivate,
                                    nSizeBytes,
...
OMX_ERRORTYPE omx_base_component_Free_SecuredInBuffer(   
            OMX_IN  OMX_HANDLETYPE hComponent,
            OMX_IN  OMX_U32 nPortIndex,
            OMX_IN  OMX_BUFFERHEADERTYPE* pBuffer) {
  omx_base_component_PrivateType* omx_base_component_Private = (omx_base_component_PrivateType*)((OMX_COMPONENTTYPE*)hComponent)->pComponentPrivate;
  ...
  return pPort->Port_Free_SecuredInBuffer(pPort,
                                nPortIndex,
                                pBuffer);
}
