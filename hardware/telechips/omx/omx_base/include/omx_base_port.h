...
#define omx_base_PortType_FIELDS \
  ...
  OMX_ERRORTYPE (*Port_Allocate_SecuredInBuffer)(omx_base_PortType *openmaxStandPort,OMX_INOUT OMX_BUFFERHEADERTYPE** pBuffer,OMX_IN OMX_U32 nPortIndex,OMX_IN OMX_PTR pAppPrivate,OMX_IN OMX_U32 nSizeBytes, OMX_IN OMX_U32 nStartAddr, OMX_IN OMX_U32 nActualSizebytes);/**< Replaces the AllocateBuffer call for the base port. */   \
  ...
  OMX_ERRORTYPE (*Port_Free_SecuredInBuffer)(omx_base_PortType *openmaxStandPort,OMX_U32 nPortIndex,OMX_BUFFERHEADERTYPE* pBuffer); /**< The standard free buffer function applied to the port class */ 
