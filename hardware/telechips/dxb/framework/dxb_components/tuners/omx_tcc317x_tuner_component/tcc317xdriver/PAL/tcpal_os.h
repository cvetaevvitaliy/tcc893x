...
TCBB_FUNC TcpalTime_t TcpalGetTimeIntervalCount_ms (TcpalTime_t _startTimeCount);
...
TCBB_FUNC I32S TcpalCreateSemaphore(TcpalSemaphore_t *_semaphore, I08S *_name, I32U _initialCount);
