...
DERIVEDCLASS(omx_mn88472_tuner_component_PrivateType, omx_base_source_PrivateType)
#define omx_mn88472_tuner_component_PrivateType_FIELDS omx_base_source_PrivateType_FIELDS \
  int		countrycode; \
  int		dxb_standard; //broadcasting standard, DVBT, ISDBT, TDMB
ENDCLASS(omx_mn88472_tuner_component_PrivateType)
...
void omx_mn88472_tuner_component_BufferMgmtCallback(
...
OMX_ERRORTYPE omx_mn88472_tuner_component_MessageHandler(
	OMX_COMPONENTTYPE* openmaxStandComp, 
