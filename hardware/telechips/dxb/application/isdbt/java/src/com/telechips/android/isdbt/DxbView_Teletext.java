...
public class DxbView_Teletext extends DxbView implements View.OnClickListener, View.OnFocusChangeListener
{
	...
	public void setVisible(boolean v)
	{
		...
		if(v)
		{
			...
			getPlayer().cOption.teletext	= true;
			playTeletext(1);
		...
		{
			getPlayer().cOption.teletext	= false;
			stopTeletext();
		}
	...
	private void playTeletext(int state)
	{
		DxbLog(I, "playTeletext(state="+state+")");
	
		if (getPlayer().isValid())
		{
			getPlayer().playTeletext(state);
