 ...
 */
package com.telechips.android.isdbt.util;
...
public class DxbUtil {
	...
	public static int getMJD(int MJD, int Hour, int Polarity, int Offset) {
		int mjd;
	...
	public static int getHour(int Hour, int Polarity, int Offset) {
		int hour;
	...
	public static int getMinute(int Minute, int Polarity, int Offset) {
		int min;
