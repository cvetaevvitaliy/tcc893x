...
public class ScheduleAlert extends Activity
{
	...
	private void setBundleData(Bundle bundle)
	{
		...
		Log(D, "iAlarm_Type=" + gInformation.dataBundle.iAlarm_Type + ", iID=" + gInformation.dataBundle.iID + ", iType_Repeat=" + gInformation.dataBundle.iType_Repeat);
	}
	...
	private void scheduler_Start()
	{
		...
		else
		{
			...
			intent.setClassName("com.telechips.android.isdbt", "com.telechips.android.isdbt.ISDBTPlayerActivity");
