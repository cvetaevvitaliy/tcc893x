...
public class DB_SUBTITLE_Data {
	...
	public DB_SUBTITLE_Data(Parcel in) {

		uiSubtitlePID = in.readInt();
		...
		stracSubtLangCode = new String(temp, 0, i);

		uiSubtType = in.readInt();
		uiCompositionPageID = in.readInt();
		uiAncillaryPageID = in.readInt();
	}
}
