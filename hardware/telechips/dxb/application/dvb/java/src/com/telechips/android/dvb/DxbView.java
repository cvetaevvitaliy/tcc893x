...
public class DxbView {
	...
	//	Dialog
	protected static final int DIALOG_SCAN_DEFAULT = 0;
	protected static final int DIALOG_SCAN_MANUAL = 1;
	protected static final int DIALOG_SCAN_BLIND = 2;
	protected static final int DIALOG_FAVOURITE_LIST = 3;
	public static final int DIALOG_MANUAL_SCAN_OPTION = 4;
	...
	private final DVBPlayerActivity mContext;
	...
	public DxbView(Context context) {
		mContext = (DVBPlayerActivity)context;
	}

	protected DVBPlayerActivity getContext() {
		return mContext;
	}
	...
	{
		DxbLog(I, "setChannel()");
		if (getPlayer().getLocalPlayState() == LOCAL_STATE.STOP || getPlayer().getServiceType() == 2)
		{
	...
	protected boolean press_InputChannel(int keyCode)
	{
		...
		if(tvInputChannel == null)
		{
			...
			tvInputChannel.setTextSize(getTextSize(18));
		}
