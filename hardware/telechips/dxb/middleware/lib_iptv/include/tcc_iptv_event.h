...
#ifndef _TCC_IPTV_EVENT_H_
#define	_TCC_IPTV_EVENT_H_
...
* typedefs & structure
******************************************************************************/
typedef struct TCC_IPTV_SI_DEC_CMD_Structure
{
	char	SIData[1024];	//Output
	int 		SIDataLength;	//Output
	int 		SIDataType;	//Output
	int 		Result; 		// Output
}TCC_IPTV_SI_DEC_CMD_t,*pTCC_IPTV_SI_DEC_CMD_t;
