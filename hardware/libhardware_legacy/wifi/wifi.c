...
int is_wifi_driver_loaded() {
    ...
    if (!property_get(DRIVER_PROP_NAME, driver_status, NULL)
        ...
        ALOGE("wlan.driver.status is ok");
...
int wifi_connect_to_supplicant()
{
    ...
    //ALOGE("wifi_connect_to_supplicant: path : %s", path);
