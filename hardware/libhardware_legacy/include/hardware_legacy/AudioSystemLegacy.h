...
enum audio_source {
    ...
    AUDIO_SOURCE_LINE_IN = 9,
    AUDIO_SOURCE_MAX = AUDIO_SOURCE_LINE_IN,
...
public:
    ...
    enum audio_devices {
        // Planet 20120219 Device Enum fix Start
        DEVICE_NONE                     = 0x0,
        /* reserved bits */
        DEVICE_BIT_IN                   = 0x80000000,
        DEVICE_BIT_DEFAULT              = 0x40000000,
        // Planet 20120219 Device Enum fix End
        // output devices
        ...
        DEVICE_OUT_SPDIF_PCM = 0x10000000,	// SPDIF PCM Planet 20121107
        //DEVICE_OUT_DEFAULT = 0x8000,
        DEVICE_OUT_DEFAULT = DEVICE_BIT_DEFAULT,	// Planet 20120219 Device Enum fix
        DEVICE_OUT_ALL = (DEVICE_OUT_EARPIECE | DEVICE_OUT_SPEAKER | DEVICE_OUT_WIRED_HEADSET |
                DEVICE_OUT_WIRED_HEADPHONE | DEVICE_OUT_BLUETOOTH_SCO | DEVICE_OUT_BLUETOOTH_SCO_HEADSET |
                DEVICE_OUT_BLUETOOTH_SCO_CARKIT | DEVICE_OUT_BLUETOOTH_A2DP | DEVICE_OUT_BLUETOOTH_A2DP_HEADPHONES |
                DEVICE_OUT_BLUETOOTH_A2DP_SPEAKER | DEVICE_OUT_AUX_DIGITAL |
                DEVICE_OUT_ANLG_DOCK_HEADSET | DEVICE_OUT_DGTL_DOCK_HEADSET | DEVICE_OUT_SPDIF_PCM |	// SPDIF PCM Planet 20121107
                DEVICE_OUT_DEFAULT),
        DEVICE_OUT_ALL_A2DP = (DEVICE_OUT_BLUETOOTH_A2DP | DEVICE_OUT_BLUETOOTH_A2DP_HEADPHONES |
                DEVICE_OUT_BLUETOOTH_A2DP_SPEAKER),

        // input devices
#if 0	// Planet 20120219 Device Enum fix Start
        ...
        DEVICE_IN_LINE 					= DEVICE_BIT_IN | 0x2000,
        DEVICE_IN_DEFAULT 				= DEVICE_BIT_IN | DEVICE_BIT_DEFAULT,
#endif	// Planet 20120219 Device Enum fix End

        DEVICE_IN_ALL = (DEVICE_IN_COMMUNICATION | DEVICE_IN_AMBIENT | DEVICE_IN_BUILTIN_MIC |
                DEVICE_IN_BLUETOOTH_SCO_HEADSET | DEVICE_IN_WIRED_HEADSET | DEVICE_IN_AUX_DIGITAL |
                DEVICE_IN_VOICE_CALL | DEVICE_IN_BACK_MIC | DEVICE_IN_LINE | DEVICE_IN_DEFAULT)
    };
    ...
    enum forced_config {
        ...
        FORCE_SPDIF_PCM,	// SPDIF PCM Planet 20121107
        NUM_FORCE_CONFIG,
