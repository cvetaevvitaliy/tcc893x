...
static int ap_set_force_sampling_rate(struct audio_policy *pol, uint32_t rate)
{
	struct legacy_audio_policy *lap = to_lap(pol);
    return lap->apm->setForceSamplingRate(rate);
}
                            ...
                            struct audio_policy **ap)
{
    ...
    lap->policy.set_force_sampling_rate = ap_set_force_sampling_rate;	// Planet 20130205 setSamplingRate
