...
private:
	...
	void			  signalVideoLayerUpdate();
	void			  signalUILayerUpdate();
	void handleMessageRefresh(int isVideo);
	void doComposition(int isVideo);
	void doDisplayComposition(const sp<const DisplayDevice>& hw, const Region& inDirtyRegion,int isVideo);
#endif
