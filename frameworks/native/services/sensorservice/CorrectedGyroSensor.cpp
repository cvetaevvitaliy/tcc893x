...
status_t CorrectedGyroSensor::setCalibration(void* ident,int handle, float x, float y, float z)
{
    return mSensorFusion.setCalibration(this,x,y,z);
}

status_t CorrectedGyroSensor::startCalibration(void* ident,int handle)
{
    return mSensorFusion.startCalibration(this);
}
