...
status_t OrientationSensor::setCalibration(void* ident,int handle, float x, float y, float z)
{
    return mSensorFusion.setCalibration(this,x,y,z);
}

status_t OrientationSensor::startCalibration(void* ident,int handle)
{
