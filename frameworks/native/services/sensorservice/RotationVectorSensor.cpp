...
status_t RotationVectorSensor::setCalibration(void* ident, int handle,float x, float y, float z)
{
    mSensorFusion.setCalibration(this, x,y,z);
    return NO_ERROR;
}

status_t RotationVectorSensor::startCalibration(void* ident, int handle)
{
    mSensorFusion.startCalibration(this);
    return NO_ERROR;
}
...
status_t GyroDriftSensor::setCalibration(void* ident, int handle,float x, float y, float z)
{
    mSensorFusion.setCalibration(this, x,y,z);
    return NO_ERROR;
}

status_t GyroDriftSensor::startCalibration(void* ident, int handle)
{
    mSensorFusion.startCalibration(this);
    return NO_ERROR;
}
