...
status_t LinearAccelerationSensor::setCalibration(void* ident, int handle, float x, float y, float z) {
    return mGravitySensor.setCalibration(ident, handle, x,y,z);
}

status_t LinearAccelerationSensor::startCalibration(void* ident, int handle) {
    return mGravitySensor.startCalibration(ident, handle);
}
