...
public:
    ...
    virtual status_t setCalibration(void* ident,int handle,float x, float y, float z) = 0;
    virtual status_t startCalibration(void* ident,int handle) = 0;	
...
public:
    ...
    virtual status_t setCalibration(void* ident,int handle,float x, float y, float z);
    virtual status_t startCalibration(void* ident,int handle);
    virtual status_t flush(void* ident, int handle);
