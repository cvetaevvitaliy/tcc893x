...
status_t SensorDevice::setCalibration(void* ident, int handle, float x, float y, float z) {
    if (!mSensorDevice) return NO_INIT;
    //return mSensorDevice->setCalibration(mSensorDevice, handle, x,y,z);
return NO_INIT;
}

status_t SensorDevice::startCalibration(void* ident, int handle) {
    if (!mSensorDevice) return NO_INIT;
    //return mSensorDevice->startCalibration(mSensorDevice, handle);
return NO_INIT;
}
// ---------------------------------------------------------------------------
}; // namespace android
