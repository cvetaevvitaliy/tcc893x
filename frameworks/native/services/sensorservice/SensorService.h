        ...
        protected Thread
{
    ...
    class SensorEventConnection : public BnSensorEventConnection {
        ...
        virtual status_t setCalibration(int handle,int sensor, float x, float y, float z);
        virtual status_t startCalibration(int handle,int sensor);
...
public:
    ...
    status_t setCalibration(const sp<SensorEventConnection>& connection, int handle, int sensors, float x, float y, float z);
    status_t startCalibration(const sp<SensorEventConnection>& connection, int handle, int sensors);
