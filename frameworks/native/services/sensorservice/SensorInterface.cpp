...
status_t HardwareSensor::setCalibration(void* ident,int handle, float x, float y, float z) {
    return mSensorDevice.setCalibration(ident, handle,x,y,z);
}

status_t HardwareSensor::startCalibration(void* ident,int handle) {
    return mSensorDevice.startCalibration(ident, handle);
}
