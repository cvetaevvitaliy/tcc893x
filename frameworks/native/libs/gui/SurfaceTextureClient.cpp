...
int SurfaceTextureClient::perform(int operation, va_list args)
{
	...
	case NATIVE_WINDOW_SET_SYNCHRONOUS_MODE:
		res = dispatchSetSynchronousMode(args);
		break;
	#endif
    default:
        res = NAME_NOT_FOUND;
...
#ifdef TCC_VIDEO_DISPLAY_BY_VSYNC_INT
int SurfaceTextureClient::dispatchSetSynchronousMode(va_list args) {
	int mode = va_arg(args, int);
	status_t res = mSurfaceTexture->setSynchronousMode(mode ? true : false);
    return res;
}
#endif
