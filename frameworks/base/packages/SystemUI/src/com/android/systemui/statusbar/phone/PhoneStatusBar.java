...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode {
	...
	if(SystemProperties.get("tcc.solution.mbox","0").equals("1")){
		final BatteryMeterView batterymeter =
			(BatteryMeterView)mStatusBarView.findViewById(R.id.battery);

		batterymeter.setVisibility(View.GONE);
	}
    ...
    private View.OnClickListener mRebootClickListener = new View.OnClickListener() {
        public void onClick(View v) {
                Intent intent = new Intent().setClassName("com.android.settings", "com.android.settings.RebootPopup");
    ...
    private void prepareNavigationBarView() {
	 ...
	 mNavigationBarView.getRebootButton().setOnClickListener(mRebootClickListener);
        updateSearchPanel();
    }
