...
public class NavigationBarView extends LinearLayout {
    ...
    public View getRebootButton() {
	return mCurrentView.findViewById(R.id.reboot);
    }
    ...
    public void setDisabledFlags(int disabledFlags, boolean force) {
	 ...
	 if((SystemProperties.get("ro.product.model","0").equals("TCC8925_HDMI_DONGLE")) ||(SystemProperties.get("ro.product.model","0").equals("TCC8935_HDMI_DONGLE"))){
		getRebootButton().setVisibility(disableRecent     ? View.INVISIBLE : View.VISIBLE);
	 } else {
		getRebootButton().setVisibility(disableRecent     ? View.GONE : View.GONE);
	 }
