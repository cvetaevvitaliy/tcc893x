...
public class StorageNotification extends SystemUI {
    ...
    private void onStorageStateChangedAsync(String path, String oldState, String newState) {
        if (true) Slog.i(TAG, String.format(
                "KSJUNG - Media {%s} state changed from {%s} -> {%s}", path, oldState, newState));
        ...
        for (int i = 0; i < length; i++) {
            if (storageVolumes[i].getPath().equals(path)) {
               description = storageVolumes[i].getDescription(mContext);
							 target = i;
							 Log.i(TAG, "KSJUNG - i : " + i + "target : " + target);
							 Log.i(TAG, "KSJUNG - storageVolumes[i].getPath() : " + storageVolumes[i].getPath());
            }
        }
		
        if (description.contains("Network File System")) {
             return;
        }
        ...
        if (newState.equals(Environment.MEDIA_SHARED)) {
             ...
             * UMS notification.
             */
            if (description.contains(mContext.getResources().getString(com.android.internal.R.string.storage_usb))) {
                setMediaStorageNotification(
                        com.android.internal.R.string.ext_usb_media_checking_notification_title,
                        com.android.internal.R.string.ext_usb_media_checking_notification_message,
            ...
            if (!mStorageManager.isUsbMassStorageEnabled()) {
                if (oldState.equals(Environment.MEDIA_SHARED)) {
                    ...
                    if (Environment.isExternalStorageRemovable()) {
                        if (description.contains(mContext.getResources().getString(com.android.internal.R.string.storage_usb))) {
                            setMediaStorageNotification(
                                    com.android.internal.R.string.ext_usb_media_safe_unmount_notification_title,
                                    com.android.internal.R.string.ext_usb_media_safe_unmount_notification_message,
            ...
            if (description.contains(mContext.getResources().getString(com.android.internal.R.string.storage_usb))) {
                setMediaStorageNotification(
                        com.android.internal.R.string.ext_usb_media_nofs_notification_title,
                        com.android.internal.R.string.ext_usb_media_nofs_notification_message,
             ...
             */
          	Intent intent = new Intent();
            intent.setClass(mContext, com.android.internal.app.ExternalMediaFormatActivity.class);
						intent.putExtra(StorageVolume.EXTRA_STORAGE_VOLUME, storageVolumes[target]);	//ksjung
						Log.i(TAG, "KSJUNG - storageVolumes[target].getPath() : " + storageVolumes[target].getPath());
            //PendingIntent pi = PendingIntent.getActivity(mContext, 0, intent, 0);
            PendingIntent pi = PendingIntent.getActivity(mContext, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
              
					if (description.contains(mContext.getResources().getString(com.android.internal.R.string.storage_usb))) {
                setMediaStorageNotification(
                        com.android.internal.R.string.ext_usb_media_unmountable_notification_title,
                        com.android.internal.R.string.ext_usb_media_unmountable_notification_message,
                        com.android.internal.R.drawable.stat_notify_sdcard_usb, true, true, null);
            } else {
                setMediaStorageNotification(
            ...
            if (description.contains(mContext.getResources().getString(com.android.internal.R.string.storage_usb))) {
                setMediaStorageNotification(
                        com.android.internal.R.string.ext_usb_media_nomedia_notification_title,
                        com.android.internal.R.string.ext_usb_media_nomedia_notification_message,
            ...
            if (description.contains(mContext.getResources().getString(com.android.internal.R.string.storage_usb))) {
                setMediaStorageNotification(
                        com.android.internal.R.string.ext_usb_media_badremoval_notification_title,
                        com.android.internal.R.string.ext_usb_media_badremoval_notification_message,
