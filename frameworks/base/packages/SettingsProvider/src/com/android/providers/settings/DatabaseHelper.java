...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadIntegerSetting(stmt, Settings.System.SCREEN_OFF_TIMEOUT,
                    R.integer.def_screen_off_timeout);
            loadIntegerSetting(stmt, Settings.System.APP_ROTATION,
                    R.integer.def_app_rotation);
            loadIntegerSetting(stmt, Settings.System.MOUSE_M_BUTTON_EVENT,
                    R.integer.def_mouse_m_button_event);
            loadIntegerSetting(stmt, Settings.System.MOUSE_R_BUTTON_EVENT,
                    R.integer.def_mouse_r_button_event);

            loadIntegerSetting(stmt, Settings.System.OUTPUT_MODE,
                    R.integer.def_output_mode);

            if ("fullhd".equals(SystemProperties.get("ro.system.hdmi_max_resolution"))) {
                loadIntegerSetting(stmt, Settings.System.HDMI_RESOLUTION,
                        R.integer.def_hdmi_hd_resolution);
            } else {
                loadIntegerSetting(stmt, Settings.System.HDMI_RESOLUTION,
                        R.integer.def_hdmi_resolution);
            }

            loadIntegerSetting(stmt, Settings.System.HDMI_AUTO_SELECT,
                    R.integer.def_hdmi_auto_select);

            loadIntegerSetting(stmt, Settings.System.HDMI_CEC_SELECT,
                    R.integer.def_hdmi_cec_select);

            loadIntegerSetting(stmt, Settings.System.HDMI_MODE,
                        R.integer.def_hdmi_mode);

            loadIntegerSetting(stmt, Settings.System.HDMI_COLOR_SPACE,
                        R.integer.def_hdmi_color_space);

            loadIntegerSetting(stmt, Settings.System.COMPOSITE_MODE,
                    R.integer.def_composite_mode);

            loadIntegerSetting(stmt, Settings.System.COMPONENT_RESOLUTION,
                    R.integer.def_component_resolution);
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            if (("TCC8925_HDMI_DONGLE".equals(SystemProperties.get("ro.product.model"))) || ("TCC8935_HDMI_DONGLE".equals(SystemProperties.get("ro.product.model")))) {
                loadSetting(stmt, Settings.Secure.WIFI_ON,"1" );
            } else {
