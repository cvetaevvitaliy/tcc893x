...
public class KeyguardViewMediator {
    ...
    // true if the keyguard is disabled
    ...
    public KeyguardViewMediator(Context context, LockPatternUtils lockPatternUtils) {
        ...
        mDisabled = mContext.getResources().getBoolean(com.android.internal.R.bool.config_disable_keyguard);
		if(mDisabled) mShowing = false;
