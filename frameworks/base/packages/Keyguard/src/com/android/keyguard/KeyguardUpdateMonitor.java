...
public class KeyguardUpdateMonitor {
    ...
    private final Handler mHandler = new Handler() {
    	boolean mIsQBEnable = SystemProperties.getBoolean("ro.QB.enable", false);
    	boolean mIsLoadedProperty = false;
        @Override
        public void handleMessage(Message msg) {
        	if( mIsQBEnable && !mIsLoadedProperty && (msg.what == MSG_TIME_UPDATE || msg.what == MSG_BATTERY_UPDATE) ) {
        		
        		if( !SystemProperties.get("tcc.hibernate.property", "").equals("reloaded") )
        			return;
        		
        		mIsLoadedProperty = true;
        	}
