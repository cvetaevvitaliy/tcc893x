...
public class WifiMonitor {
    ...
    private static final String P2P_PERSISTENT_REQUEST_STR = "P2P-PERSISTENT-REQUEST";
   ...
   /* Network connection completed */
    ...
    public static final int P2P_PERSISTENT_REQUEST_EVENT         = BASE + 44;
    ...
    private static class MonitorThread extends Thread {
        ...
        private void handleP2pEvents(String dataString) {
            ...
            } else if(dataString.startsWith(P2P_PERSISTENT_REQUEST_STR)) {
                 mStateMachine.sendMessage(P2P_PERSISTENT_REQUEST_EVENT, new WifiP2pDevice(dataString));
            }
        }
