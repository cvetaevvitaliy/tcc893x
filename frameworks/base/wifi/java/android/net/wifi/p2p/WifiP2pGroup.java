...
public class WifiP2pGroup implements Parcelable {
    ...
    private String mNetworkName4User;
    ...
    /** @hide */
    public void setNetworkName4User(String networkName) {
        mNetworkName4User = networkName;
    }
    ...
    public String getNetworkName4User() {
        return mNetworkName4User;
    }
    ...
    public WifiP2pGroup(WifiP2pGroup source) {
        if (source != null) {
            ...
            mNetworkName4User= source.getNetworkName4User();
