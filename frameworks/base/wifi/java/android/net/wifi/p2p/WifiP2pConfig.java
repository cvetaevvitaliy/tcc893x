...
public class WifiP2pConfig implements Parcelable {
    private static final String TAG = "WifiP2pConfig";
    /**
     ...
     * @hide
     */
    public int wfd_ctrl_port;

    /**
     * message: send mssage to application
     * @hide
     */
    public int message;
    ...
    public String toString() {
        ...
        sbuf.append("\n wfd_ctrl_port: ").append(wfd_ctrl_port);
    ...
    public WifiP2pConfig(WifiP2pConfig source) {
        if (source != null) {
            ...
            netId = source.netId;
            wfd_ctrl_port = source.wfd_ctrl_port;
    ...
    public static final Creator<WifiP2pConfig> CREATOR =
        new Creator<WifiP2pConfig>() {
            public WifiP2pConfig createFromParcel(Parcel in) {
                ...
                config.wfd_ctrl_port = in.readInt();
                config.message = in.readInt();
                return config;
            }
