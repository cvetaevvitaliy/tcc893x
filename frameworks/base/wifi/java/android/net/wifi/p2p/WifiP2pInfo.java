...
/**
 * A class representing connection information about a Wi-Fi p2p group & WFD rtsp port
 *
 * {@see WifiP2pManager}
 */
public class WifiP2pInfo implements Parcelable {
    ...
    public String toString() {
        ...
        sbuf.append("groupFormed: ").append(groupFormed)
            ...
            .append("mWfdRtspPort: ").append(mWfdRtspPort);
    ...
    public WifiP2pInfo(WifiP2pInfo source) {
        if (source != null) {
            ...
            mWfdRtspPort = source.mWfdRtspPort;
       }
    }
