...
public class WifiP2pManager {
    ...
    /** @hide */
    public static final int ENABLE_P2P                              = BASE + 67;
    /** @hide */
    public static final int ENABLE_P2P_FAILED                       = BASE + 68;
    /** @hide */
    public static final int ENABLE_P2P_SUCCEEDED                    = BASE + 69;

    /** @hide */
    public static final int DISABLE_P2P                             = BASE + 70;
    /** @hide */
    public static final int DISABLE_P2P_FAILED                      = BASE + 71;
    /** @hide */
    public static final int DISABLE_P2P_SUCCEEDED                   = BASE + 72;
    /** @hide */
    public static final int REQUEST_WPS_PBC                        = BASE + 73;
    /** @hide */
    public static final int SET_LISTEN_CHANNEL                       = BASE + 74;
    /** @hide */
    public static final int REQUEST_TEMP_DISCONNECT_WIFI	= BASE + 75;
    /** @hide */
    public static final int REQUEST_TEMP_RECONNECT_WIFI		= BASE + 76;
    /** @hide */
    public static final int REQUEST_P2P_FLUSH       		= BASE + 77;
    /** @hide */
    public static final int MESSAGE_SEND                    = BASE + 78;
    /** @hide */
    public static final int START_WPS                               = BASE + 79;
    /** @hide */
    public static final int START_WPS_FAILED                        = BASE + 80;
    /** @hide */
    public static final int START_WPS_SUCCEEDED                     = BASE + 81;
    ...
    /** @hide */
    public static final int P2P_GO_NEG_SUCCESS = 10;
    public static final int P2P_GROUP_FORMATION_SUCCESS = 11;    
    public static final int P2P_GO_NEG_FAIL = 12;
    public static final int P2P_GROUP_FORMATION_FAIL = 13;
    public static final int P2P_GROUP_REMOVED = 14;
    public static final int P2P_GROUP_STARTED = 15;

    /** @hide */
    public static final int START_LISTEN                            = BASE + 85;
    /** @hide */
    public static final int START_LISTEN_FAILED                     = BASE + 86;
    /** @hide */
    public static final int START_LISTEN_SUCCEEDED                  = BASE + 87;

    /** @hide */
    public static final int STOP_LISTEN                             = BASE + 88;
    /** @hide */
    public static final int STOP_LISTEN_FAILED                      = BASE + 89;
    /** @hide */
    public static final int STOP_LISTEN_SUCCEEDED                   = BASE + 90;

    /** @hide */
    public static final int SET_CHANNEL                             = BASE + 91;
    /** @hide */
    public static final int SET_CHANNEL_FAILED                      = BASE + 92;
    /** @hide */
    public static final int SET_CHANNEL_SUCCEEDED                   = BASE + 93;
   ...
   public interface DnsSdTxtRecordListener {
    ...
    public interface DialogListener {
        ...
        /**
         * Called by the system when a request a message
         *
         * Application can then call {@link #connect} with the given config if the request
         * is acceptable.
         *
         ...
         * @param config p2p configuration.
         */
        public void onMessageRequested(WifiP2pDevice device, WifiP2pConfig config);
         ...
         * failed to attach.
         *
         * Application can request again using setDialogListener when it is
         * in the foreground.
         *
         * @param reason The reason for failure could be one of ERROR,
         * BUSY, P2P_UNSUPPORTED or NOT_IN_FOREGROUND
         */
            ...
            public void handleMessage(Message message) {
                ...
                switch (message.what) {
                    ...
                    case WifiP2pManager.CONNECTION_REQUESTED:
                        ...
                        break;
                    case WifiP2pManager.MESSAGE_SEND:
                        if (mDialogListener != null) {
                            Bundle bundle = message.getData();
                            mDialogListener.onMessageRequested(
                                    (WifiP2pDevice)bundle.getParcelable(
                                            P2P_DEV_BUNDLE_KEY),
                                    (WifiP2pConfig)bundle.getParcelable(
                                            P2P_CONFIG_BUNDLE_KEY));
   ...
   /**
     ...
     * @hide
     */
    public void requestWpsPbc(Channel c) {
        Log.d(TAG, "requestWpsPbc");
        checkChannel(c);
        c.mAsyncChannel.sendMessage(REQUEST_WPS_PBC);
    }
     ...
     * @hide
     */
    public void setListenChannel(Channel c, int channel) {
        Log.d(TAG, "setListenChannel channel = " + channel);
        checkChannel(c);
        c.mAsyncChannel.sendMessage(SET_LISTEN_CHANNEL, channel);
    }
    
    /**
     * requestTempDisconnectWifi
     *
     * 
     * @param c is the channel created at {@link #initialize}
     * @hide
     */
    public void requestTempDisconnectWifi(Channel c) {
        Log.d(TAG, "requestTempDisconnectWifi");
        checkChannel(c);
        c.mAsyncChannel.sendMessage(REQUEST_TEMP_DISCONNECT_WIFI);
    }
     ...
     * @hide
     */
    public void requestTempReconnectWifi(Channel c) {
        Log.d(TAG, "requestTempReconnectWifi");
        checkChannel(c);
        c.mAsyncChannel.sendMessage(REQUEST_TEMP_RECONNECT_WIFI);
    }
     ...
     * @hide
     */
    public void requestP2pFlush(Channel c) {
        Log.d(TAG, "requestP2pFlush");
        checkChannel(c);
        c.mAsyncChannel.sendMessage(REQUEST_P2P_FLUSH);
    }
