...
public class AudioSystem
{
	...
	public static final int DEVICE_OUT_SPDIF_PCM = 0x10000000;	// SPDIF PCM Planet 20121107
    ...
    public static final int DEVICE_OUT_ALL = (DEVICE_OUT_EARPIECE |
                                              ...
                                              DEVICE_OUT_SPDIF_PCM |	// SPDIF PCM Planet 20121107
                                              DEVICE_OUT_DEFAULT);
	...
	public static final String DEVICE_OUT_SPDIF_PCM_NAME = "spdif_pcm";		// SPDIF PCM Planet 20121107
    ...
    public static String getDeviceName(int device)
    {
		...
		case DEVICE_OUT_SPDIF_PCM:
			return DEVICE_OUT_SPDIF_PCM_NAME;	// SPDIF PCM Planet 20121107
	...
	public static final int FORCE_SPDIF_PCM = 12;		// SPDIF PCM Planet 20121107
	...
	public static native int setForceSamplingRate(int rate);	// Planet 20130205 setSamplingRate
