...
public class AudioService extends IAudioService.Stub {
   ...
   /** @hide Maximum volume index values for audio streams */
	...
	/** @see AudioManager#setSPDIFPCMOn() */
    public void setSPDIFPCMOn(boolean on){
        if (on) {
            AudioSystem.setForceUse(AudioSystem.FOR_MEDIA, AudioSystem.FORCE_SPDIF_PCM);
            mForcedUseForComm = AudioSystem.FORCE_SPDIF_PCM;
        } else {
    ...
    /** @see AudioManager#isSPDIFPCMOn() */
    public boolean isSPDIFPCMOn() {
        if (mForcedUseForComm == AudioSystem.FORCE_SPDIF_PCM) {
            return true;
        } else {
            return false;
        }
