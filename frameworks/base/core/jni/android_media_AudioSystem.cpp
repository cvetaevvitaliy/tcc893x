...
// Planet 20130205 setSamplingRate
static int
android_media_AudioSystem_setForceSamplingRate(JNIEnv *env, jobject thiz, jint rate)
{
    return check_AudioSystem_Command(AudioSystem::setForceSamplingRate(rate));
}
static jint
...
static JNINativeMethod gMethods[] = {
    ...
    {"setForceSamplingRate","(I)I",     (void *)android_media_AudioSystem_setForceSamplingRate},	// Planet 20130205 setSamplingRate
