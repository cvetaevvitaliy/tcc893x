...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        public synchronized static void initNameValueCache() {
        	sNameValueCache.init();
        	Secure.initNameValueCache();
        }
         ...
         * @hide
         */
        public static final String SPDIF_SETTING = "spdif_setting"; 	
        /**
         * Output mode. HDMI, component, or composite.
         * @hide
         */
	...
	/**
         ...
         * @hide
         */
        public static final String NTP_CONF = "ntp_conf";

        /** @hide */
        public static final String APP_ROTATION = "app_rotation";

        /** @hide */
        public static final String MOUSE_M_BUTTON_EVENT = "mouse_m_button_event";

        /** @hide */
        public static final String MOUSE_R_BUTTON_EVENT = "mouse_r_button_event";
	    ...
	    HDMI_CEC_SELECT,
            ...
            ETH_IFNAME,
            APP_ROTATION,
            MOUSE_M_BUTTON_EVENT,
            MOUSE_R_BUTTON_EVENT,
            RINGTONE,
            NOTIFICATION_SOUND
        };
