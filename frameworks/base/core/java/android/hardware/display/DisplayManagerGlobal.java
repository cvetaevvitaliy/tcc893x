...
public final class DisplayManagerGlobal {
    ...
    private boolean mWifiDisplayScan;
    ...
    public void startWifiDisplayScan() {
        synchronized (mLock) {
            Log.e(TAG, "startWifiDisplayScan: mWifiDisplayScan: " + mWifiDisplayScan);
            if (mWifiDisplayScan == false) {
                registerCallbackIfNeededLocked();
                try {
                    Log.e(TAG, "START SCAN Wifi displays.");
                    mDm.startWifiDisplayScan();
					mWifiDisplayScan = true;
                } catch (RemoteException ex) {
    ...
    public void stopWifiDisplayScan() {
        synchronized (mLock) {
            Log.e(TAG, "stopWifiDisplayScan: mWifiDisplayScan: " + mWifiDisplayScan);
            if (mWifiDisplayScan == true) {
                try {
                    Log.e(TAG, "STOP SCAN Wifi displays.");
                    mDm.stopWifiDisplayScan();
					mWifiDisplayScan = false;
                } catch (RemoteException ex) {
                    Log.e(TAG, "Failed to scan for Wifi displays.", ex);
                }
            } else {
                Log.wtf(TAG, "Wifi display didn't scan");
            }
        }
    }
