...
public class SystemSensorManager extends SensorManager {
    ...
    /** @hide */
    public boolean setCalibrationData(int sensorType, float[] values) {
        ...
        if(sensor == null)
            return false;
        handle = sensor.getHandle();
        //Log.e(TAG, "setCalibrationData sensor :" + sensorType+ " handle : "+handle +" ,v0[" + values[0] + "]  v1["+ values[1] + "] v2[" + values[2] + "] result : " + result);
        if(sensors_data_set_calibration(sQueue,handle, sensorType,-values[0],-values[1],-values[2]) == true)
            result = true;
        //Log.e(TAG, "setCalibrationData sensor result : " + result);*/
        return true;
    }

    /** @hide */
    public boolean startCalibrationData(int sensorType) {
        /*boolean result = false;
        Sensor sensor = getDefaultSensor(sensorType);
        int handle = -1;
        if(sensor == null)
        ...
        handle = sensor.getHandle();
        //Log.e(TAG, "setCalibrationData sensor :" + sensorType+ " handle : "+handle +" ,v0[" + values[0] + "]  v1["+ values[1] + "] v2[" + values[2] + "] result : " + result);
        if(sensors_data_start_calibration(sQueue,handle, sensorType) == true)
            result = true;
        //Log.e(TAG, "setCalibrationData sensor result : " + result);*/
        return true;
    }
