...
public final class PointerIcon implements Parcelable {
    ...
    private static int getSystemIconStyleIndex(int style) {
        switch (style) {
            case STYLE_ARROW:
                if (SystemProperties.getInt("tcc.solution.mbox", 0) == 1) {
                    int output = SystemProperties.getInt("persist.sys.output_mode", 1);
                    if(output == 1){
                        int resolution = SystemProperties.getInt("persist.sys.hdmi_resolution", 1);
                        if(resolution == 6 || resolution == 7 || resolution == 8){
                            return com.android.internal.R.styleable.Pointer_pointerIconArrow_stb_15;
                        } else if(resolution == 4 || resolution == 5) {
                            return com.android.internal.R.styleable.Pointer_pointerIconArrow_stb_24;
                        }
                    } else if(output == 2) {
                        return com.android.internal.R.styleable.Pointer_pointerIconArrow_stb_15;
                    } else if(output == 3) {
                        int resolution = SystemProperties.getInt("persist.sys.component_mode", 1);
                        if(resolution == 0) {
                            return com.android.internal.R.styleable.Pointer_pointerIconArrow_stb_24;
                        }
                    }
                    return com.android.internal.R.styleable.Pointer_pointerIconArrow_stb_30;
                }
