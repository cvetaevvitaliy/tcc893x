...
public class Intent implements Parcelable, Cloneable {
    ...
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_PRE_QUICKBOOT = "android.intent.action.PRE_QUICKBOOT";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_POST_QUICKBOOT = "android.intent.action.POST_QUICKBOOT";

	@SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_RELOAD_QUICKBOOT = "android.intent.action.RELOAD_QUICKBOOT";
    
	@SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_TZ_CHANGED_QUICKBOOT = "android.intent.action.TZ_CHANGED_QUICKBOOT";
    /**
   ...
   /**
    ...
    /**
     * Broadcast Action:  The media scanner has finished prescanning a directory.
     * The path to the scanned directory is contained in the Intent.mData field.
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_MEDIA_SCANNER_PRESCAN_FINISHED = "android.intent.action.MEDIA_SCANNER_PRESCAN_FINISHED";
