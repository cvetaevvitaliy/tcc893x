...
public class ExternalMediaFormatActivity extends AlertActivity implements DialogInterface.OnClickListener {
    ...
    private BroadcastReceiver mStorageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
						Log.i("Activity", "KSJUNG - onRecive ");
    ...
    protected void onCreate(Bundle savedInstanceState) {
						Log.i("Activity", "KSJUNG - onCreate ");
		...
		protected void onNewIntent(Intent intent) {
						Log.i("Activity", "KSJUNG - onNewIntent ");
    ...
    protected void onResume() {
						Log.i("Activity", "KSJUNG - onResume ");
        super.onResume();
    ...
    public void onClick(DialogInterface dialog, int which) {
						Log.i("Activity", "KSJUNG - onClick ");

        if (which == POSITIVE_BUTTON) {
            Intent intent = new Intent(ExternalStorageFormatter.FORMAT_ONLY);
            intent.setComponent(ExternalStorageFormatter.COMPONENT_NAME);
            StorageVolume mStorageVolume = getIntent().getParcelableExtra(StorageVolume.EXTRA_STORAGE_VOLUME);
						Log.i("Activity", "KSJUNG - mStorageVolume.getPath() : " + mStorageVolume.getPath());
