...
public:
    ...
    virtual sp<PointerControllerInterface> changePointerController(int32_t deviceId);
...
sp<PointerControllerInterface> NativeInputManager::changePointerController(int32_t deviceId) {
    AutoMutex _l(mLock);
