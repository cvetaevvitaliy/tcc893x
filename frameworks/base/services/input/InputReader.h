...
public:
    ...
    virtual sp<PointerControllerInterface> changePointerController(int32_t deviceId) = 0;
...
private:
    ...
    bool virtualPointerController(nsecs_t when, uint32_t policyFlags, int32_t keyCode,
            bool down, nsecs_t downTime);
