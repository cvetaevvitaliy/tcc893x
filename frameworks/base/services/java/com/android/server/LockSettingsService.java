...
public class LockSettingsService extends ILockSettings.Stub {
    ...
    protected static final String TAG = "LockSettingsService";
    ...
    protected void writeToDb(String key, String value, int userId) {
    ...
    protected String readFromDb(String key, String defaultValue, int userId) {
        Cursor cursor;
