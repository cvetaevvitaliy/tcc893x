...
class AlarmManagerService extends IAlarmManager.Stub {
	...
	private boolean mForceTimeChanged = false;
	...
	*/
    ...
    class ClockReceiver extends BroadcastReceiver {
        public ClockReceiver() {
			...
			filter.addAction(Intent.ACTION_TZ_CHANGED_QUICKBOOT);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (intent.getAction().equals(Intent.ACTION_TZ_CHANGED_QUICKBOOT)) {
				String tz = SystemProperties.get(TIMEZONE_PROPERTY);
        		if (tz != null) {
					mForceTimeChanged = true;
            		setTimeZone(tz);
					mForceTimeChanged = false;
					scheduleTimeTickEvent();
                	scheduleDateChangedEvent();
        		}
			}
