...
public class ConnectivityService extends IConnectivityManager.Stub {
     ...
     * abstractly.
     */
    protected NetworkStateTracker mNetTrackers[];
    ...
    public ConnectivityService(Context context, INetworkManagementService netManager,
        ...
        if(mMediaBox)
		mNetworkPreference =  ConnectivityManager.TYPE_ETHERNET;
        else
        ...
        for (int targetNetworkType : mPriorityList) {
            ...
            try {
                if (config.radio == ConnectivityManager.TYPE_ETHERNET) {
                    if (DBG) Slog.v(TAG, "Starting Ethernet Service.");
                    tracker = new EthernetStateTracker(context, mTrackerHandler);
                    mNetTrackers[targetNetworkType] = tracker;
                    EthernetService ethernetService = new EthernetService(context, (EthernetStateTracker) tracker);
                    ServiceManager.addService(Context.ETH_SERVICE, ethernetService);
                } else {
        ...
        /* don't need on Telechips platform.
