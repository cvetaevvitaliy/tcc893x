...
public class UsbDeviceManager {
    ...
    private static final String USB_CONNECTED_PROPERTY =
	    "sys.usb.connected";
    ...
    private static final int MSG_USB_READY = 6;
    ...
    private final class UsbHandler extends Handler {
        ...
        private String mCurrentUsbMode;		
        ...
        public void updateState(String state) {
            ...
            if ("DISCONNECTED".equals(state)) {
                connected = 0;
                configured = 0;
		SystemProperties.set(USB_CONNECTED_PROPERTY, "0");
                ...
                connected = 1;
                configured = 1;
		SystemProperties.set(USB_CONNECTED_PROPERTY, "1");
            } else {
		...
		if ((model_product.equals("TCC8930_STB_EV") || model_product.equals("TCC8930_YJ8930T") || model_product.equals("TCC8935_YJ8935T") || product.equals("tcc893x") || product.equals("m805_893x")) && !chip_product.equals("tcc8935s")) {					
			if (functions.equals("device")) {
				Slog.e(TAG, "Enable usb device mode");
				// set usb device		
			      SystemProperties.set("sys.usb.mode", "usb_device");
//				setAdbEnabled(true);
				return;  
			} else if (functions.equals("host")) {
				Slog.e(TAG, "Enable usb host mode");
	                	//if (mAdbEnabled) {
	      ...
	      String chip_product = SystemProperties.get("ro.chip.product", "");		
            ...
            switch (msg.what) {
                case MSG_UPDATE_STATE:
                   ...
                   if ((product.equals("tcc893x") || product.equals("m805_893x")) && !chip_product.equals("tcc8935s")) {					
			  	showUSBMode();  
			  } else {
            ...
            if ((product.equals("tcc893x") || product.equals("m805_893x")) && !chip_product.equals("tcc8935s")) {					
			  ...
			  // B090162		
            if ((product.equals("tcc893x") || product.equals("m805_893x")) && !chip_product.equals("tcc8935s")) {					
		        	mHandler.sendEmptyMessage(MSG_USB_READY);					
			  }				
                    break;
            ...
            if ((product.equals("tcc893x") || product.equals("m805_893x")) && !chip_product.equals("tcc8935s")) {					
                    ...
                    break;
                case MSG_USB_READY:
			  if (DEBUG) Slog.v(TAG, "Recv MSG_USB_READY");
            if ((product.equals("tcc893x") || product.equals("m805_893x")) && !chip_product.equals("tcc8935s")) {					
			  	showUSBMode();
			  }
	            try {
	...
	private void showUSBMode() {
		if (DEBUG) Slog.v(TAG, "showUSBMode");
	    	if (mNotificationManager == null || !mUseUsbNotification) return;			
		int id = 0;
		Resources r = mContext.getResources();

		id = com.android.internal.R.string.usb_mod_notification_title;
		if (id != 0) {
