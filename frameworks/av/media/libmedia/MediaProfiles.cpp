...
MediaProfiles::createDefaultVideoEncoders(MediaProfiles *profiles)
{
    ...
    profiles->mVideoEncoders.add(createDefaultH264VideoEncoderCap());//TELECHIPS, ZzaU 
}
...
MediaProfiles::createDefaultEncoderOutputFileFormats(MediaProfiles *profiles)
{
    ...
    profiles->mEncoderOutputFileFormats.add(OUTPUT_FORMAT_MPEG2TS); // 2013 04 12 swhwang, added createDefaultEncoderOutputFileFormats for support MPEG2TS Format
}
