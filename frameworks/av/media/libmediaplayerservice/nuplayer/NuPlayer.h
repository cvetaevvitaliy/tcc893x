...
#ifdef _TCC_PROPRIETARY_DEPENDENCIES_
    friend struct TCCNuPlayer;
    friend struct TCCRTSPSource;
    friend class  TCCNuPlayerDelegate;
#endif
...
#ifdef _TCC_PROPRIETARY_DEPENDENCIES_
    friend struct TCCNuPlayerDelegate;
    sp<TCCNuPlayerDelegate> mDelegateClass;
#endif
    enum FlushStatus {
        NONE,
