...
NuPlayer::RTSPSource::RTSPSource(
    ...
    mSubSource = new TCCRTSPSource(this);
    mDelegateClass = new TCCSourceDelegate<TCCRTSPSource>();
#else
    mSubSource = this;
    mDelegateClass = new TCCSourceDelegate<RTSPSource>();
#endif
...
#ifdef _TCC_PROPRIETARY_DEPENDENCIES_
status_t NuPlayer::RTSPSource::dequeueAccessUnit_l(bool audio, sp<ABuffer> *accessUnit) {
    return mDelegateClass->dequeueAccessUnit(audio, accessUnit);
}
#endif
...
void NuPlayer::RTSPSource::onMessageReceived(const sp<AMessage> &msg) {
    ...
    switch (what) {
        ...
        {
#ifdef _TCC_PROPRIETARY_DEPENDENCIES_
            mDelegateClass->onDisconnected(msg);
#else
            onDisconnected(msg);
#endif
            break;
