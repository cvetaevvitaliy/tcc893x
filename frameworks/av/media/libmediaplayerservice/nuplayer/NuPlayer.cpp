...
#ifdef _TCC_PROPRIETARY_DEPENDENCIES_
        sp<TCCNuPlayer> tccnuplayer = new TCCNuPlayer(this);
        mDelegateClass = new TCCNuPlayerDelegate(tccnuplayer);
#endif
    ...
    switch (msg->what()) {
        case kWhatSetDataSource:
        {
            ...
            if(mDelegateClass == NULL) {
                mDelegateClass = new TCCNuPlayerDelegate();
            }
            mDelegateClass->setOwner(this);
#endif
            break;
        }
        ...
        {
#ifdef _TCC_PROPRIETARY_DEPENDENCIES_
            mDelegateClass->onSourceNotify(msg);
#else
            onSourceNotify(msg);
#endif
            break;
