...
VideoFrame *StagefrightMetadataRetriever::getFrameAtTime(
    ...
    sp<MetaData> fileMeta = mExtractor->getMetaData(true);
...
// TELECHIPS, SSG, we only use a HW decoder
#if 0
    VideoFrame *frame =
...
MediaAlbumArt *StagefrightMetadataRetriever::extractAlbumArt() {
    ...
    if (!mParsedMetaData) {
        parseMetaData(true); // TELECHIPS, SSG
...
const char *StagefrightMetadataRetriever::extractMetadata(int keyCode) {
    ...
    if (!mParsedMetaData) {
        parseMetaData(false); // TELECHIPS, SSG
...
void StagefrightMetadataRetriever::parseMetaData(bool withThumbnail) {
    sp<MetaData> meta = mExtractor->getMetaData(withThumbnail); // TELECHIPS, SSG
