...
#include "TCCMyHandlerDelegate.h"
#include "TCCMyHandler.h"
#endif
...
struct MyHandler : public AHandler {
    ...
    MyHandler(
        ...
        mSubSource = new TCCMyHandler(this);
        mDelegateClass = new TCCMyHandlerDelegate<TCCMyHandler>();
#else
        mSubSource = this;
        mDelegateClass = new TCCMyHandlerDelegate<MyHandler>();
#endif
        sp<AMessage> subClass_mesg = new AMessage(0,id());
    ...
    void connectDefaultType(bool type) {
        mDelegateClass->connectDefaultType(type);
    }
    ...
    void onMessageReceivedD(const sp<AMessage> &msg) {
        switch (msg->what()) {
            ...
            case 'play':
            {
                ...
                if (result == OK) {
                    ...
                    if (response->mStatusCode != 200) {
                        ...
                        mDelegateClass->parsePlayResponse(response);
            ...
            case 'accu':
            {
                ...
                mDelegateClass->postAccessUnitTimeoutCheck();
...
#ifdef _TCC_PROPRIETARY_DEPENDENCIES_
        mDelegateClass->onMessageReceived(msg);
#else
        switch (msg->what()) {
            case 'conn':
            {
...
private:
#ifdef _TCC_PROPRIETARY_DEPENDENCIES_
    friend struct TCCMyHandler;
#if _USE_TCC_NUPLAYER_
    friend struct TCCMyHandlerDelegate<TCCMyHandler>;
    TCCMyHandler *mSubSource;
    TCCMyHandlerDelegate<TCCMyHandler>* mDelegateClass;
#else
    friend struct TCCMyHandlerDelegate<MyHandler>;
    MyHandler* mSubSource;
    TCCMyHandlerDelegate<MyHandler>* mDelegateClass;
#endif
#endif
