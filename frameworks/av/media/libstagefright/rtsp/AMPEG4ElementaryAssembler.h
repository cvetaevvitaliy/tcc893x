...
#include "TCCAMPEG4ElementaryAssembler.h"
#include "TCCAMPEG4ElementaryAssemblerDelegate.h"
#endif
...
#ifdef _TCC_PROPRIETARY_DEPENDENCIES_
    friend struct TCCAMPEG4ElementaryAssembler;
#if _USE_TCC_NUPLAYER_
    friend struct TCCAMPEG4ElementaryAssemblerDelegate<TCCAMPEG4ElementaryAssembler>;
    TCCAMPEG4ElementaryAssembler *mSubSource;
    TCCAMPEG4ElementaryAssemblerDelegate<TCCAMPEG4ElementaryAssembler>* mDelegateClass;
#else
    friend struct TCCAMPEG4ElementaryAssemblerDelegate<AMPEG4ElementaryAssembler>;
    AMPEG4ElementaryAssembler* mSubSource;
    TCCAMPEG4ElementaryAssemblerDelegate<AMPEG4ElementaryAssembler>* mDelegateClass;
#endif
#endif
protected:
