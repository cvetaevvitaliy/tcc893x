...
AMPEG4ElementaryAssembler::AMPEG4ElementaryAssembler(
    ...
    mSubSource = new TCCAMPEG4ElementaryAssembler(this);
    mDelegateClass = new TCCAMPEG4ElementaryAssemblerDelegate<TCCAMPEG4ElementaryAssembler>();
#else
    mSubSource = this;
    mDelegateClass = new TCCAMPEG4ElementaryAssemblerDelegate<AMPEG4ElementaryAssembler>();
#endif
...
ARTPAssembler::AssemblyStatus AMPEG4ElementaryAssembler::assembleMore(
        const sp<ARTPSource> &source) {
#ifdef _TCC_PROPRIETARY_DEPENDENCIES_
    AssemblyStatus status = mDelegateClass->addPacket(source);
#else
