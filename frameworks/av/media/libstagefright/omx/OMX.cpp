...
#ifdef TCC_OMX
    msg.u.extended_buffer_data.platform_private = pBuffer->pOutputPortPrivate;
#else
...
//TELECHIPS, ZzaU :: for V2IP
    ...
    {
	    TCC_PLATFORM_PRIVATE_PMEM_INFO *pPMEM_info = (TCC_PLATFORM_PRIVATE_PMEM_INFO*)pBuffer->pOutputPortPrivate;
        msg.u.extended_buffer_data.data_phy_addr = (uint32_t)pPMEM_info->offset[0];
    }
    else
    {
        msg.u.extended_buffer_data.data_phy_addr = NULL;
    }
#endif
