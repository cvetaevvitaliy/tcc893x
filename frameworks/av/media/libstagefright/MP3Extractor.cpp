...
MP3Extractor::MP3Extractor(
    ...
    switch (layer) {
        case 1:
            mMeta->setCString(kKeyMIMEType, MEDIA_MIMETYPE_AUDIO_MPEG_TCC/*MEDIA_MIMETYPE_AUDIO_MPEG_LAYER_I*/);
            break;
        case 2:
            mMeta->setCString(kKeyMIMEType, MEDIA_MIMETYPE_AUDIO_MPEG_TCC/*MEDIA_MIMETYPE_AUDIO_MPEG_LAYER_II*/);
            break;
        case 3:
...
bool SniffMP3(
    ...
    *confidence = 0.2f;
    ...
    ext.toUpper();
    if (!strncasecmp(ext.string(), ".MP3", 4)) {
         *confidence = 0.9f;
    }
	// <--- telechips
