...
#ifndef _TCC_FOUNDATION_
#define _TCC_FOUNDATION_
#endif
...
#ifdef _TCC_FOUNDATION_
status_t ALooperRoster::postMessageAtFront(
        const sp<AMessage> &msg, int64_t delayUs) {
    Mutex::Autolock autoLock(mLock);
    return postMessage_l(msg, delayUs, true);
}
#endif
...
#ifdef _TCC_FOUNDATION_
    immediate ? looper->postAtFront(msg) :
#endif
