...
// ===> Telechips, ZzaU
    ...
    MediaBuffer* inputBuffer1 = NULL;
    MediaBuffer* inputBuffer2 = NULL;
    MediaBuffer* inputBuffer3 = NULL;
// <=====================
    ...
    encoder = TCCOMXCodec::Create(client.interface(), metaData, true,
        encoderSource, NULL, codecFlags, NULL, false);
...
// ===> Telechips, ZzaU    
    inputBuffer1 = new MediaBuffer(size);
    inputBuffer1->meta_data()->setInt64(kKeyTime, 33000);
    nbBuffer = encoderSource->storeBuffer(inputBuffer1);
    inputBuffer2 = new MediaBuffer(size);
    inputBuffer2->meta_data()->setInt64(kKeyTime, 66000);
    nbBuffer = encoderSource->storeBuffer(inputBuffer2);
    inputBuffer3 = new MediaBuffer(size);
    inputBuffer3->meta_data()->setInt64(kKeyTime, 100000);
    nbBuffer = encoderSource->storeBuffer(inputBuffer3);
// <=====================
...
M4OSA_ERR VideoEditorVideoEncoder_open(M4ENCODER_Context pContext,
    ...
    pEncoderContext->mEncoder = TCCOMXCodec::Create(
        pEncoderContext->mClient.interface(), encoderMetadata, true,
        pEncoderContext->mEncoderSource, NULL, codecFlags, NULL, false);
