...
const char CameraParameters::KEY_USB_CAMERA_SUPPORTED[] = "Support-UVC_Camera"; /* 20130429 swhwang, added for Support USB Camera Frame */
...
void CameraParameters::setUsbCameraSupported(int Uvc_Cam)
{
    set(KEY_USB_CAMERA_SUPPORTED, Uvc_Cam);
}
int CameraParameters::getUsbCameraSupported() const
{
    return getInt(KEY_USB_CAMERA_SUPPORTED);
}
