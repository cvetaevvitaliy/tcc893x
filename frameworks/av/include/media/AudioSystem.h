...
public:
	...
	static status_t setVoipMode(int mode);
	static status_t setVoipPid(int mode, int pid);
    ...
    static status_t getStreamVolumeIndex(audio_stream_type_t stream,
                                         int *index,
                                         audio_devices_t device);
	static status_t setForceSamplingRate(uint32_t rate);	// Planet 20130205 setSamplingRate
