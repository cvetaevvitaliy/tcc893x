...
#define BUFFER_DELAY // Telechips, ZzaU :: for inline view of flash player.
#ifdef BUFFER_DELAY
#define ADELAY_MAX 3 // Caution: MAX Count is 3.
#define ADELAY_CNT 2 // Caution: MAX Count is 3.
#endif
...
#ifdef BUFFER_DELAY
	BufferInfo *mLast_dequed[ADELAY_MAX];
#endif
