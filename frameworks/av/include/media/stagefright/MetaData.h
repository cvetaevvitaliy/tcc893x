...
enum {
    ...
    kKeyDecodeIframe      = 'DecI',  // int32_t (bool), TELECHIPS, B060955
    kKeyPacketDisCont     = 'PaCo',  // int32_t (bool), for WFD
    ...
    kKeyTCCCodecInfo      = 'TCIF',  // raw data, TELECHIPS, SSG
    ...
    // TELECHIPS, HEES -    // To prevent side-effect of video display
    kKeyDecodeOnly        = 'DecO',  // int32_t (bool), mosaic image
    kKeyMediaExtractor    = 'extr',  // int32_t, display time mismatched
    kKeyIsStreamingMedia  = 'sTre',  // int32_t (bool)
    kKeyTimeGoesMissing   = 'tmMs',  // int32_t (bool)


    // Multi-audio selection
    kKeyVideoTrackCount	  = 'vtcn',  // int32_t
    kKeyAudioTrackCount   = 'atcn',  // int32_t
    kKeyAudioInfoPrepare  = 'atif',  // int32_t

    //TELECHIPS, ZzaU :: for V2IP
    kKeyNodeId			  = 'node',  // int32_t

    // TELECHIPS, AVG 2012/03/15
    kKeyGetStreamMode     = 'gstm',
