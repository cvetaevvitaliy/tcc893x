...
enum media_info_type {
    ...
    // Telechips
    // The http server doesn't support range request: it can't execute queued seekTo
    // fast enough.
    MEDIA_INFO_VIDEO_SEEK_LAGGING = 750,
...
enum media_parameter_keys {
    ...
    KEY_PARAMETER_TOTAL_AUDIO_TRACK_COUNT = 2000,    	        // get only
    KEY_PARAMETER_GET_CURRENT_AUDDIO_TRACK_IDX = 2001,          // get only
    KEY_PARAMETER_PREPARE_TO_GET_AUDIO_TRACK_INFO = 2002,       // set only
    KEY_PARAMETER_GET_AUDIO_LANGUAGE_INFO = 2003,               // get only
    KEY_PARAMETER_GET_AUDIO_CODEC_INFO = 2004,                  // get only
    KEY_PARAMETER_DO_CHANGE_AUDIO_TRACK  = 2005,                // set only

    // Screen Mode Change
    KEY_PARAMETER_CHANGE_SCREENMODE                 = 4000,
    KEY_PARAMETER_CHANGE_SCREENMODE_CROP_LEFT       = 4001,
    KEY_PARAMETER_CHANGE_SCREENMODE_CROP_TOP        = 4002,
    KEY_PARAMETER_CHANGE_SCREENMODE_CROP_RIGHT      = 4003,
    KEY_PARAMETER_CHANGE_SCREENMODE_CROP_BOTTOM     = 4004,

    // Internal Subtitle Support
    KEY_PARAMETER_CHECK_INTERSUBTITLE_EXISTENCE  = 5000,            // get only
    KEY_PARAMETER_INTERSUBTITLE_GET_TEXTDATA     = 5001,            // get only
    KEY_PARAMETER_INTERSUBTITLE_GET_PGSDATA      = 5002,            // get only
    KEY_PARAMETER_INTERSUBTITLE_SET_SEEKPOSITION = 5003,            // Set only
    KEY_PARAMETER_INTERSUBTITLE_GET_CLASS_NUM    = 5004,
    KEY_PARAMETER_INTERSUBTITLE_SET_CLASS        = 5005,

    // WFD, User Input Back Channel
    KEY_PARAMETER_ENABLE_WFD_UIBC = 7000,
    KEY_PARAMETER_DISABLE_WFD_UIBC = 7001,
    KEY_PARAMETER_SET_WFD_UIBC_DOWN = 7002,
    KEY_PARAMETER_SET_WFD_UIBC_UP = 7003,
    KEY_PARAMETER_SET_WFD_UIBC_MOVE = 7004,

    // For Media Info
    KEY_PARAMETER_GET_AUDIO_CODECTYPE  = 8000,
    KEY_PARAMETER_GET_VIDEO_CODECTYPE  = 8001,
    KEY_PARAMETER_GET_VIDEO_FRAMERATE  = 8002,
    KEY_PARAMETER_GET_AUDIO_SAMPLERATE = 8003,
    KEY_PARAMETER_GET_BITRATE          = 8004,
};
...
enum media_player_invoke_ids {
	...
	INVOKE_ID_SET_PLAYRATE = 7,
	INVOKE_ID_GET_PLAYRATE = 8,
};
