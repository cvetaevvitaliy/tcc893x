...
public:
    ...
    void setUsbCameraSupported(int Uvc_Cam);
    int getUsbCameraSupported() const;
    ...
    // Support USB CAMERA
    static const char KEY_USB_CAMERA_SUPPORTED[]; /* 20130429 swhwang, added for Support USB Camera Frame */
