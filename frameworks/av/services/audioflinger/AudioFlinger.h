...
static const nsecs_t kStandbyTimeVoipInNsecs = seconds(3);		// VoipAudio Planet 20121212
...
#include "Effects.h"
    ...
    mutable     hardware_call_state                 mHardwareStatus;    // for dump only
				...
				// VoipAudio Planet 20121212 Start
				AudioStreamOut*           			mAudioStreamOut;
				AudioStreamIn*            			mAudioStreamIn;
                bool                                mVoipMode;
                #define PID_LIST_MAX	8
                int                                 mVoipPidList[PID_LIST_MAX];
				// VoipAudio Planet 20121212 End
