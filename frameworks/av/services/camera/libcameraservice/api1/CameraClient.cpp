...
status_t CameraClient::sendCommand(int32_t cmd, int32_t arg1, int32_t arg2) {
	...
	char get_orientation[PROPERTY_VALUE_MAX];
	property_get("persist.sys.display_orientation", get_orientation, "");
        value = atoi(get_orientation);

        if(value == 90) value = 270;
        else if(value == 270) value = 90;

        orientation = getOrientation(value, mCameraFacing == CAMERA_FACING_FRONT);
...
bool CameraClient::lockIfMessageWanted(int32_t msgType) {
    ...
    while (mMsgEnabled & msgType) {
        ...
        usleep(CHECK_MESSAGE_INTERVAL * 1000);
         LOG1("CHECK_MESSAGE_INTERVAL (%d)ms!!!!", CHECK_MESSAGE_INTERVAL*sleepCount);
	   if(sleepCount>10) {
	    LOG1("CHECK_MESSAGE Time out...............................................");
	   return false;
	   }
    }
