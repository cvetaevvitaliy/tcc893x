...
public interface ControllerOverlay {
  ...
  // VIEW_SUBTITLE
  void setSubtitle(int index, String subtitle);
  void setPGSCaption(int OffsetX, int OffsetY, int Srcwidth, int SrcHeight, int Dstwidth, int DstHeight, int StreamSize, int[] StreamData);
}
