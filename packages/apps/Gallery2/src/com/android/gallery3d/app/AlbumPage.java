...
// VIEW_SUBTITLE
import com.android.gallery3d.ui.VideoSettings;
...
public class AlbumPage extends ActivityState implements GalleryActionBar.ClusterRunner,
    ...
    protected boolean onCreateActionBar(Menu menu) {
        ...
        if (mGetContent) {
            ...
            // VIEW_SUBTITLE
            menu.findItem(R.id.action_videosettings).setVisible(false); //disable Gallery sub menu video setting : 20130107 swhwang
    ...
    protected boolean onItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            // VIEW_SUBTITLE
            case R.id.action_videosettings: {
                Context context = mActivity.getAndroidContext();
                final Intent intent = new Intent();
                intent.setClass(context, VideoSettings.class);
