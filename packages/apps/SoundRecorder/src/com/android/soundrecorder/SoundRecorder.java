...
import android.os.SystemProperties;    // B090183
import android.provider.MediaStore;
import android.util.Log;
import android.view.KeyEvent;
import android.view.View;
import android.widget.Button;
import android.widget.ToggleButton; // B090183
...
public class SoundRecorder extends Activity 
    ...
    static final String AUDIO_MP3  = "audio/mpeg";  // B090183
    ...
    static final int BITRATE_MP3  = 128000;   // B090183

    static int   mAudioButtonFlag = 0;  // B090183
    ...
    ToggleButton mCodecTypeButton;      // B090183
    ToggleButton mAudioInputPortButton; // B090183
    ...
    public void onCreate(Bundle icycle) {
        ...
        if (i != null) {
            String s = i.getType();
            if (AUDIO_AMR.equals(s) || AUDIO_3GPP.equals(s) || AUDIO_ANY.equals(s) || AUDIO_MP3.equals(s)
                    || ANY_ANY.equals(s)) {
                mRequestedType = s;
            } else if (s != null) {
        ...
        mAudioButtonFlag = SystemProperties.getInt("ro.audiobutton.enable", 0); // B090183
    ...
    private void initResourceRefs() {
        ...
        // S: B090183
        mCodecTypeButton      = (ToggleButton) findViewById(R.id.CodecTypeButton);
        mAudioInputPortButton = (ToggleButton) findViewById(R.id.AudioInputPortButton);

        mCodecTypeButton.setOnClickListener(this);
        mAudioInputPortButton.setOnClickListener(this);
        // E: B090183
    ...
    public void onClick(View button) {
        ...
        switch (button.getId()) {
                ...
                if (!Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                    ...
                    if (AUDIO_AMR.equals(mRequestedType)) {
                        ...
                        mRecorder.startRecording(MediaRecorder.OutputFormat.THREE_GPP, ".3gpp",
                                this);
                    } else if (AUDIO_MP3.equals(mRequestedType)) {      // B090183
                        mRemainingTimeCalculator.setBitRate(BITRATE_MP3);
                        mRecorder.startRecording(MediaRecorder.OutputFormat.TCC_MP3, ".mp3",
                                this);
                    } else {
                    ...
                    if (mMaxFileSize != -1) {
                        ...
                        mRemainingTimeCalculator.setFileSizeLimit(
                                mRecorder.sampleFile(), mRecorder.getMaxFileSize());
                    }
                }
                break;
            ...
            case R.id.discardButton:
                ...
                break;
            // S: B090183
            case R.id.CodecTypeButton:
                if(mCodecTypeButton.isChecked()) {
                    mRequestedType = AUDIO_MP3;
                    mRecorder.setCodecType(Recorder.RECORDING_CODEC_MP3);
                }
                else {
                    mRequestedType = AUDIO_3GPP;
                    mRecorder.setCodecType(Recorder.RECORDING_CODEC_AMR);
                }
                break;
            case R.id.AudioInputPortButton:
                if(mAudioInputPortButton.isChecked()) {
                    mRecorder.setAudioInputPort(Recorder.AUDIO_INPUT_PORT_LINE);
                }
                else {
                    mRecorder.setAudioInputPort(Recorder.AUDIO_INPUT_PORT_MIC);
                }
                break;
            // E: B090183
        }
    ...
    private void updateUi() {
        ...
        switch (mRecorder.state()) {
            case Recorder.IDLE_STATE:
                // S: B090183
                if(mAudioButtonFlag == 1) {
                    mCodecTypeButton.setEnabled(true);
                    mCodecTypeButton.setFocusable(true);
                    mAudioInputPortButton.setEnabled(true);
                    mAudioInputPortButton.setFocusable(true);
                }
                else {
                    mCodecTypeButton.setVisibility(View.INVISIBLE);
                    mAudioInputPortButton.setVisibility(View.INVISIBLE);
                }
                // E: B090183
            ...
            case Recorder.RECORDING_STATE: 
                ...
                // S: B090183
                if(mAudioButtonFlag == 1) {
                    mCodecTypeButton.setEnabled(false);
                    mCodecTypeButton.setFocusable(false);
                    mAudioInputPortButton.setEnabled(false);
                    mAudioInputPortButton.setFocusable(false);
                }
                // E: B090183
