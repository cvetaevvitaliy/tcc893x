...
public final class Launcher extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(SystemProperties.get("tcc.solution.mbox", "0").equals("1"))
        {
			...
			{
				editor.putBoolean(Cling.WORKSPACE_CLING_DISMISSED_KEY, true);
			}
			if(!prefs.getBoolean(Cling.ALLAPPS_CLING_DISMISSED_KEY, false))
			{
				editor.putBoolean(Cling.ALLAPPS_CLING_DISMISSED_KEY, true);
			}
			if(!prefs.getBoolean(Cling.FOLDER_CLING_DISMISSED_KEY, false))
			{
				//editor.putBoolean(Cling.FOLDER_CLING_DISMISSED_KEY, true);
			}
