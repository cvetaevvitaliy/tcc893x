 ...
 */
public final class BluetoothSettingsSTB extends DeviceListPreferenceFragment {
    ...
    private BluetoothEnablerSTB mBluetoothEnabler;
    ...
    void addPreferencesForActivity() {
        addPreferencesFromResource(R.xml.bluetooth_settings_stb);

        Activity activity = getActivity();

	 mNoDeviceFoundPreference = new Preference(activity);
        mNoDeviceFoundPreference.setLayoutResource(R.layout.preference_empty_list);
        mNoDeviceFoundPreference.setTitle(R.string.bluetooth_empty_list_bluetooth_off);
        mNoDeviceFoundPreference.setSelectable(false);

	 mCheck = (CheckBoxPreference) findPreference("bt_checkbox");

        mBluetoothEnabler = new BluetoothEnablerSTB(activity, mCheck);
	 mAccessPoints = (ProgressCategory) findPreference("bt_device_list");
    ...
    private void updateContent(int bluetoothState, boolean scanState) {
        ...
        switch (bluetoothState) {
            case BluetoothAdapter.STATE_ON:
                getPreferenceScreen().removePreference(mNoDeviceFoundPreference);
                ...
                mAccessPoints.addPreference(mMyDevicePreference);
        ...
        removeAllDevices();
        getPreferenceScreen().addPreference(mNoDeviceFoundPreference);
        getActivity().invalidateOptionsMenu();
    }
