...
public class Settings extends PreferenceActivity
    ...
    private void updateHeaderList(List<Header> target) {
        ...
        while (i < target.size()) {
            ...
            if (id == R.id.operator_settings || id == R.id.manufacturer_settings) {
                ...
                } else if ("1".equals(SystemProperties.get("tcc.solution.mbox"))) {
                    target.remove(header);
                }
            ...
            } else if (id == R.id.wifi_settings_stb) {
                if (!("1".equals(SystemProperties.get("tcc.solution.wifi.mbox")))) {
                    target.remove(header);
                }
            } else if (id == R.id.bluetooth_settings_stb) {
                if (!("1".equals(SystemProperties.get("tcc.solution.bluetooth.mbox")))) {
                    target.remove(header);
                }
                ...
                EthernetManager mEM = (EthernetManager)getSystemService(Context.ETH_SERVICE);
                // Remove Bluetooth Settings if Ethernet device is not available.
                if (mEM != null && mEM.isEthDeviceFound() == false) {
                    target.remove(header);
                }
            ...
            } else if(id == R.id.about_settings_stb){
                if (!("1".equals(SystemProperties.get("tcc.solution.mbox")))) {
                    target.remove(header);
                }
            }
    ...
    public static class BluetoothSettingsSTBActivity extends Settings { /* empty */ }
    public static class WirelessSettingsActivity extends Settings { /* empty */ }
    public static class WirelessSettingsSTBActivity extends Settings { /* empty */ }
