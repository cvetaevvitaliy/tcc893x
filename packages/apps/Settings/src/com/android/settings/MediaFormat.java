...
public class MediaFormat extends Activity {
    ...
    private Button mFinalButton;
		...
		private View mNTFSContainer;
		private CheckBox mNTFSbutton;
		private TextView mNTFStext;
    ...
    private Button.OnClickListener mFinalClickListener = new Button.OnClickListener() {
            public void onClick(View v) {
							...
							Log.d("ksjung", "ksjung - MediaFormat.java");
                ...
                final StorageVolume storageVolume = getIntent().getParcelableExtra(
								...
								Log.d("ksjung", "ksjung - StorageVolume.EXTRA_STORAGE_VOLUME : " + StorageVolume.EXTRA_STORAGE_VOLUME);
								intent.putExtra(StorageVolume.EXTRA_STORAGE_VOLUME, storageVolume);
								String mFormatType = "vfat";
								if( mNTFSbutton.isChecked() )
									mFormatType= "ntfs";
								intent.putExtra(ExternalStorageFormatter.FORMAT_TYPE, mFormatType);
                startService(intent);
                finish();
            }
        };
    ...
    private void establishFinalConfirmationState() {
        if (mFinalView == null) {
            ...
            mFinalButton.setOnClickListener(mFinalClickListener);
						...
						mNTFSContainer = mFinalView.findViewById(R.id.ntfs_format_option);
						mNTFSbutton = (CheckBox) mNTFSContainer.findViewById(R.id.format_ntfs);
						mNTFStext = (TextView) mFinalView.findViewById(R.id.media_format_desc_ntfs_format_id);
						//final View externalOption = mFinalView.findViewById(R.id.erase_external_option_text);
						//externalOption.setVisibility(View.GONE);

						mNTFSContainer.setVisibility(View.INVISIBLE);
						mNTFSbutton.setVisibility(View.INVISIBLE);
						mNTFStext.setVisibility(View.INVISIBLE);
						/*
						mNTFSContainer.setOnClickListener(new View.OnClickListener() {
								@Override
								public void onClick(View v) {
								mNTFSbutton.toggle();
								}
