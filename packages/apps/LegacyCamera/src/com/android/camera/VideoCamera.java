...
import android.os.Environment; //20120517 ysseung   rec. resolution limit.
import android.os.Handler;
import android.os.Message;
import android.os.ParcelFileDescriptor;
import android.os.SystemClock;
import android.os.SystemProperties; //20120517 ysseung   rec. resolution limit.
...
public class VideoCamera extends ActivityBase
    ...
    private void readVideoPreferences() {
        ...
        if (intent.hasExtra(MediaStore.EXTRA_DURATION_LIMIT)) {
            ...
            mMaxVideoDurationInMs = 1000 * CameraSettings.DEFAULT_VIDEO_DURATION;
        }
    ...
    private void getDesiredPreviewSize() {
        ...
        if (mParameters.getSupportedVideoSizes() == null || effectsActive()) {
            //20120517 ysseung   rec. resolution limit. - start -
            if("tcc88xx".equals(SystemProperties.get("ro.board.platform"))
                && ("/mnt/sdcard".equals(Environment.getExternalStorageDirectory().getPath())
                || "/sdcard".equals(Environment.getExternalStorageDirectory().getPath()))) {
                Log.d(TAG, "TCC88xx Platform & Storage NAND.");
            ...
            //20120517 ysseung   rec. resolution limit. - end -
