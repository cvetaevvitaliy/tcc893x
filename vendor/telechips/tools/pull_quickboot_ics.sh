...
repo forall -c git reset --hard v12.06_r1-tcc-android-4.0.4
...
cd hardware/telechips/nand_v8
echo "$PWD ------------------------------------------------------------------------------------------------------"
git reset  --hard 7a93dace972ac84066ebe2f55c907e9c72dd83f1
cd $ANDROID_BUILD_TOP
...
cd device/telechips/tcc88xx-common
echo "$PWD ------------------------------------------------------------------------------------------------------" 
git branch -D quickboot_ics
git branch quickboot_ics
git checkout quickboot_ics
